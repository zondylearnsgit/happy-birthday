...
function Ku() {
  const s = {
        ...
        return (
          this.enabled === !1 ||
            ...
            (this.spaces[r].transfer === Qe &&
              ((i.r = An(i.r)), (i.g = An(i.g)), (i.b = An(i.b))),
            ...
            this.spaces[a].transfer === Qe &&
              ((i.r = bi(i.r)), (i.g = bi(i.g)), (i.b = bi(i.b)))),
          i
        );
      },
      ...
      getTransfer: function (i) {
        return i === Nn ? Qs : this.spaces[i].transfer;
      },
    ...
    if (i !== null) {
      ...
      if (Array.isArray(i)) {
        ...
        for (let a = 0, o = i.length; a < o; a++)
          i[a].isDataTexture ? r.push(fr(i[a].image)) : r.push(fr(i[a]));
      } else r = fr(i);
      n.url = r;
    }
      ...
      return (
        E > y && E > L
          ? E < 0.01
            ...
            : ((n = Math.sqrt(E)), (i = R / n), (r = A / n))
          : y > L
          ? y < 0.01
            ? ((n = 0.707106781), (i = 0), (r = 0.707106781))
            : ((i = Math.sqrt(y)), (n = R / i), (r = D / i))
          : L < 0.01
          ? ((n = 0.707106781), (i = 0.707106781), (r = 0))
          : ((r = Math.sqrt(L)), (n = A / r), (i = D / r)),
        this.set(n, i, r, t),
        this
      );
    }
...
class Kt {
      ...
      if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0)
        ...
        e.boundingBox !== void 0
          ? (e.boundingBox === null && e.computeBoundingBox(),
            _s.copy(e.boundingBox))
          : (n.boundingBox === null && n.computeBoundingBox(),
            _s.copy(n.boundingBox)),
  ...
  intersectsTriangle(e) {
    ...
    this.getCenter(Wi),
      xs.subVectors(this.max, Wi),
      ci.subVectors(e.a, Wi),
      li.subVectors(e.b, Wi),
      ui.subVectors(e.c, Wi),
      Rn.subVectors(li, ci),
      Cn.subVectors(ui, li),
      qn.subVectors(ci, ui);
    let t = [
    ...
    return !mr(t, ci, li, ui, xs) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !mr(t, ci, li, ui, xs))
      ? !1
      : (vs.crossVectors(Rn, Cn),
        (t = [vs.x, vs.y, vs.z]),
        mr(t, ci, li, ui, xs));
  }
  clampPoint(e, t) {
    ...
    return (
      this.isEmpty()
        ...
        : (this.getCenter(e.center),
          (e.radius = this.getSize($t).length() * 0.5)),
      e
    );
  }
  intersect(e) {
  ...
  applyMatrix4(e) {
    return this.isEmpty()
      ? this
      : (pn[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e),
        pn[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(e),
        pn[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(e),
        pn[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(e),
        pn[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(e),
        pn[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(e),
        pn[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(e),
        pn[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(e),
...
function mr(s, e, t, n, i) {
  for (let r = 0, a = s.length - 3; r <= a; r += 3) {
    Yn.fromArray(s, r);
    const o =
        i.x * Math.abs(Yn.x) + i.y * Math.abs(Yn.y) + i.z * Math.abs(Yn.z),
      c = e.dot(Yn),
      l = t.dot(Yn),
      u = n.dot(Yn);
...
class hn {
  ...
  setFromPoints(e, t) {
    const n = this.center;
    t !== void 0 ? n.copy(t) : eh.setFromPoints(e).getCenter(n);
    let i = 0;
    ...
    return e.isEmpty()
      ...
      : (this.center.equals(e.center) === !0
          ...
          : (gr.subVectors(e.center, this.center).setLength(e.radius),
            this.expandByPoint(Xi.copy(e.center).add(gr)),
            this.expandByPoint(Xi.copy(e.center).sub(gr))),
        this);
  }
  equals(e) {
...
class ds {
  ...
  distanceSqToPoint(e) {
    ...
    return t < 0
      ...
      : (mn.copy(this.origin).addScaledVector(this.direction, t),
        mn.distanceToSquared(e));
  }
  distanceSqToSegment(e, t, n, i) {
    _r.copy(e).add(t).multiplyScalar(0.5),
      Ms.copy(t).sub(e).normalize(),
      Pn.copy(this.origin).sub(_r);
    ...
    return (
      ...
      i && i.copy(_r).addScaledVector(Ms, d),
      p
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, i, r) {
    ...
    const c = o * this.direction.dot(ys.crossVectors(Pn, ys));
    if (c < 0) return null;
    const l = o * this.direction.dot(xr.cross(Pn));
...
class De {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      (r[0] = a * R + o * M + c * X + l * k),
      (r[4] = a * A + o * C + c * K + l * oe),
      (r[8] = a * D + o * H + c * G + l * he),
      (r[12] = a * S + o * z + c * Z + l * ye),
      (r[1] = u * R + h * M + d * X + p * k),
      (r[5] = u * A + h * C + d * K + p * oe),
      (r[9] = u * D + h * H + d * G + p * he),
      (r[13] = u * S + h * z + d * Z + p * ye),
      (r[2] = g * R + x * M + m * X + f * k),
      (r[6] = g * A + x * C + m * K + f * oe),
      (r[10] = g * D + x * H + m * G + f * he),
      (r[14] = g * S + x * z + m * Z + f * ye),
      (r[3] = b * R + E * M + y * X + L * k),
      (r[7] = b * A + E * C + y * K + L * oe),
      (r[11] = b * D + E * H + y * G + L * he),
      (r[15] = b * S + E * z + y * Z + L * ye),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      m = e[14],
      f = e[15],
      b = h * m * l - x * d * l + x * c * p - o * m * p - h * c * f + o * d * f,
      E = g * d * l - u * m * l - g * c * p + a * m * p + u * c * f - a * d * f,
      y = u * x * l - g * h * l + g * o * p - a * x * p - u * o * f + a * h * f,
      L = g * h * c - u * x * c - g * o * d + a * x * d + u * o * m - a * h * m,
      R = t * b + n * E + i * y + r * L;
    if (R === 0)
  ...
  decompose(e, t, n) {
    ...
    const a = hi.set(i[4], i[5], i[6]).length(),
      o = hi.set(i[8], i[9], i[10]).length();
  ...
  makePerspective(e, t, n, i, r, a, o = En) {
    ...
    else if (o === er) (p = -a / (a - r)), (g = (-a * r) / (a - r));
    else
      throw new Error(
...
const Lo = new I(),
  ...
  No = { type: "added" },
  ah = { type: "removed" },
  fi = { type: "childadded", child: null },
  Mr = { type: "childremoved", child: null };
class ut extends Oi {
  constructor() {
    super(),
      (this.isObject3D = !0),
  ...
  translateOnAxis(e, t) {
    return (
      Lo.copy(e).applyQuaternion(this.quaternion),
      this.position.add(Lo.multiplyScalar(t)),
      this
    );
  }
  translateX(e) {
  ...
  lookAt(e, t, n) {
    ...
    this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? gn.lookAt(qi, Es, this.up)
        : gn.lookAt(Es, qi, this.up),
      this.quaternion.setFromRotationMatrix(gn),
      i &&
        (gn.extractRotation(i.matrixWorld),
        di.setFromRotationMatrix(gn),
  ...
  attach(e) {
    return (
      ...
      e.parent !== null &&
        (e.parent.updateWorldMatrix(!0, !1), gn.multiply(e.parent.matrixWorld)),
      e.applyMatrix4(gn),
      e.removeFromParent(),
      (e.parent = this),
      this.children.push(e),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(qi, e, sh), e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(qi, rh, e), e
    );
  }
  getWorldDirection(e) {
    this.updateWorldMatrix(!0, !1);
...
class tn {
  ...
  static getBarycoord(e, t, n, i, r) {
    Jt.subVectors(i, t), _n.subVectors(n, t), yr.subVectors(e, t);
    const a = Jt.dot(Jt),
      o = Jt.dot(_n),
      c = Jt.dot(yr),
      l = _n.dot(_n),
  ...
  static containsPoint(e, t, n, i) {
    return this.getBarycoord(e, t, n, i, xn) === null
      ? !1
  ...
  static getInterpolation(e, t, n, i, r, a, o, c) {
    return this.getBarycoord(e, t, n, i, xn) === null
      ? ((c.x = 0),
        ...
        null)
      : (c.setScalar(0),
        c.addScaledVector(r, xn.x),
        c.addScaledVector(a, xn.y),
        c.addScaledVector(o, xn.z),
        c);
  }
  static getInterpolatedAttribute(e, t, n, i, r, a) {
    return (
      ...
      Ar.setScalar(0),
      wr.setScalar(0),
      br.fromBufferAttribute(e, t),
      Ar.fromBufferAttribute(e, n),
      wr.fromBufferAttribute(e, i),
      a.setScalar(0),
      a.addScaledVector(br, r.x),
      a.addScaledVector(Ar, r.y),
      a.addScaledVector(wr, r.z),
      a
    );
  }
  ...
  closestPointToPoint(e, t) {
    ...
    if (m <= 0 && h - u >= 0 && p - g >= 0)
      return (
        Fo.subVectors(r, i),
        (o = (h - u) / (h - u + (p - g))),
        t.copy(i).addScaledVector(Fo, o)
      );
    const f = 1 / (m + x + d);
    return (
      (a = x * f),
      (o = d * f),
      t.copy(n).addScaledVector(pi, a).addScaledVector(mi, o)
    );
  }
  equals(e) {
...
class Le {
  ...
  setRGB(e, t, n, i = Ve.workingColorSpace) {
    return (
      ...
      (this.g = t),
      (this.b = n),
      Ve.colorSpaceToWorking(this, i),
      this
    );
  }
  setHSL(e, t, n, i = Ve.workingColorSpace) {
    if (((e = Ya(e, 1)), (t = Be(t, 0, 1)), (n = Be(n, 0, 1)), t === 0))
    ...
    return Ve.colorSpaceToWorking(this, i), this;
  }
  setStyle(e, t = vt) {
    function n(r) {
      r !== void 0 &&
  ...
  getHex(e = vt) {
    return (
      Ve.workingToColorSpace(St.copy(this), e),
  ...
  getHSL(e, t = Ve.workingColorSpace) {
    Ve.workingToColorSpace(St.copy(this), t);
    const n = St.r,
      i = St.g,
      r = St.b,
      a = Math.max(n, i, r),
  ...
  lerpHSL(e, t) {
    this.getHSL(In), e.getHSL(Ts);
    const n = ns(In.h, Ts.h, t),
      i = ns(In.s, Ts.s, t),
      r = ns(In.l, Ts.l, t);
...
class cn extends Oi {
  constructor() {
    super(),
      ...
      (this.stencilFail = ai),
      (this.stencilZFail = ai),
      (this.stencilZPass = ai),
      (this.stencilWrite = !1),
  ...
  toJSON(e) {
    ...
    (n.uuid = this.uuid),
      ...
      this.blending !== Ei && (n.blending = this.blending),
      this.side !== wn && (n.side = this.side),
      this.vertexColors === !0 && (n.vertexColors = !0),
      this.opacity < 1 && (n.opacity = this.opacity),
      this.transparent === !0 && (n.transparent = !0),
      this.blendSrc !== Kr && (n.blendSrc = this.blendSrc),
      this.blendDst !== jr && (n.blendDst = this.blendDst),
      ...
      this.stencilFunc !== So && (n.stencilFunc = this.stencilFunc),
      this.stencilRef !== 0 && (n.stencilRef = this.stencilRef),
      this.stencilFuncMask !== 255 &&
        (n.stencilFuncMask = this.stencilFuncMask),
      this.stencilFail !== ai && (n.stencilFail = this.stencilFail),
      this.stencilZFail !== ai && (n.stencilZFail = this.stencilZFail),
      this.stencilZPass !== ai && (n.stencilZPass = this.stencilZPass),
...
class Lt {
  ...
  toJSON() {
    ...
    return (
      ...
      this.usage !== Ia && (e.usage = this.usage),
      e
    );
  }
}
...
class rn extends Oi {
        ...
        for (let n = 0, i = t.length; n < i; n++) {
          ...
          zt.setFromBufferAttribute(r),
            this.morphTargetsRelative
              ? (xt.addVectors(this.boundingBox.min, zt.min),
                this.boundingBox.expandByPoint(xt),
                xt.addVectors(this.boundingBox.max, zt.max),
                this.boundingBox.expandByPoint(xt))
      ...
      if ((zt.setFromBufferAttribute(e), t))
        for (let r = 0, a = t.length; r < a; r++) {
          ...
          Yi.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (xt.addVectors(zt.min, Yi.min),
                zt.expandByPoint(xt),
                xt.addVectors(zt.max, Yi.max),
                zt.expandByPoint(xt))
              : (zt.expandByPoint(Yi.min), zt.expandByPoint(Yi.max));
        }
      zt.getCenter(n);
      let i = 0;
        ...
        for (let r = 0, a = t.length; r < a; r++) {
          ...
          for (let l = 0, u = o.count; l < u; l++)
            xt.fromBufferAttribute(o, l),
              c && (gi.fromBufferAttribute(e, l), xt.add(gi)),
              (i = Math.max(i, n.distanceToSquared(xt)));
        }
  ...
  computeTangents() {
    ...
    const a = this.getAttribute("tangent"),
      o = [],
      c = [];
    for (let D = 0; D < n.count; D++) (o[D] = new I()), (c[D] = new I());
    const l = new I(),
      u = new I(),
      h = new I(),
      d = new He(),
    ...
    for (let D = 0, S = b.length; D < S; ++D) {
      const M = b[D],
        C = M.start,
        H = M.count;
      for (let z = C, X = C + H; z < X; z += 3)
        f(e.getX(z + 0), e.getX(z + 1), e.getX(z + 2));
    }
    const E = new I(),
      y = new I(),
      L = new I(),
      R = new I();
    function A(D) {
      L.fromBufferAttribute(i, D), R.copy(L);
      const S = o[D];
      E.copy(S),
        E.sub(L.multiplyScalar(L.dot(S))).normalize(),
        y.crossVectors(R, S);
      const C = y.dot(c[D]) < 0 ? -1 : 1;
      a.setXYZW(D, E.x, E.y, E.z, C);
    }
    for (let D = 0, S = b.length; D < S; ++D) {
      const M = b[D],
        C = M.start,
...
class Et extends ut {
    ...
    if (r && o) {
      ...
      for (let c = 0, l = r.length; c < l; c++) {
        const u = o[c],
          h = r[c];
        u !== 0 &&
          (Pr.fromBufferAttribute(h, e),
          a ? Ps.addScaledVector(Pr, u) : Ps.addScaledVector(Pr.sub(t), u));
      }
      t.add(Ps);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    i !== void 0 &&
      ...
      !(
        As.containsPoint(Kn.origin) === !1 &&
        (Kn.intersectSphere(As, Bo) === null ||
          Kn.origin.distanceToSquared(Bo) > (e.far - e.near) ** 2)
      ) &&
        (Oo.copy(r).invert(),
        Kn.copy(e.ray).applyMatrix4(Oo),
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let g = 0, x = d.length; g < x; g++) {
          ...
          for (let y = b, L = E; y < L; y += 3) {
            const R = o.getX(y),
              A = o.getX(y + 1),
              D = o.getX(y + 2);
            (i = Is(this, f, e, n, l, u, h, R, A, D)),
              i &&
...
function uh(s, e, t, n, i, r, a, o) {
  ...
  if (
    (e.side === Nt
      ...
      : (c = n.intersectTriangle(i, r, a, e.side === wn, o)),
    c === null)
  )
    return null;
  ...
  return l < t.near || l > t.far
    ? null
    : { distance: l, point: Ls.clone(), object: s };
}
function Is(s, e, t, n, i, r, a, o, c, l) {
  s.getVertexPosition(o, ws),
    s.getVertexPosition(c, Rs),
    s.getVertexPosition(l, Cs);
  const u = uh(s, e, t, n, ws, Rs, Cs, zo);
  if (u) {
    const h = new I();
    tn.getBarycoord(zo, ws, Rs, Cs, h),
      i && (u.uv = tn.getInterpolatedAttribute(i, o, c, l, h, new He())),
      r && (u.uv1 = tn.getInterpolatedAttribute(r, o, c, l, h, new He())),
      a &&
        ((u.normal = tn.getInterpolatedAttribute(a, o, c, l, h, new I())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1));
    const d = { a: o, b: c, c: l, normal: new I(), materialIndex: 0 };
    tn.getNormal(ws, Rs, Cs, d.normal), (u.face = d), (u.barycoord = h);
  }
  return u;
}
class Bi extends rn {
  constructor(e = 1, t = 1, n = 1, i = 1, r = 1, a = 1) {
    ...
    function g(x, m, f, b, E, y, L, R, A, D, S) {
      const M = y / A,
        C = L / D,
        H = y / 2,
        z = L / 2,
      ...
      for (let he = 0; he < D; he++)
        for (let ye = 0; ye < A; ye++) {
          const Oe = d + ye + K * he,
            ...
            q = d + (ye + 1) + K * (he + 1),
            te = d + (ye + 1) + K * he;
          c.push(Oe, tt, te), c.push(tt, q, te), (k += 6);
        }
      o.addGroup(p, k, S), (p += k), (d += Z);
    }
  }
  copy(e) {
    return (
...
class Vn extends cn {
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = hh(e.uniformsGroups)),
...
class Rt extends ll {
  ...
  getEffectiveFOV() {
    return Ii * 2 * Math.atan(Math.tan(ts * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
...
class mh extends ut {
  constructor(e, t, n) {
    ...
    const i = new Rt(_i, xi, e, t);
    (i.layers = this.layers), this.add(i);
    const r = new Rt(_i, xi, e, t);
    (r.layers = this.layers), this.add(r);
    const a = new Rt(_i, xi, e, t);
    (a.layers = this.layers), this.add(a);
    const o = new Rt(_i, xi, e, t);
    (o.layers = this.layers), this.add(o);
    const c = new Rt(_i, xi, e, t);
    (c.layers = this.layers), this.add(c);
    const l = new Rt(_i, xi, e, t);
...
class ul extends Mt {
  constructor(e = [], t = Ci, n, i, r, a, o, c, l, u) {
...
class yh extends Et {
  ...
  raycast(e, t) {
    ...
    n !== void 0 &&
      ...
      e.ray.intersectsSphere(Ir) !== !1 &&
        (qo.copy(i).invert(),
        Dr.copy(e.ray).applyMatrix4(qo),
        !(
          this.boundingBox !== null && Dr.intersectsBox(this.boundingBox) === !1
        ) && this._computeIntersections(e, t, Dr)));
  }
  getVertexPosition(e, t) {
  ...
  applyBoneTransform(e, t) {
    const n = this.skeleton,
      i = this.geometry;
    Go.fromBufferAttribute(i.attributes.skinIndex, e),
      Wo.fromBufferAttribute(i.attributes.skinWeight, e),
    ...
    for (let r = 0; r < 4; r++) {
      ...
      if (a !== 0) {
        ...
        Xo.multiplyMatrices(n.bones[o].matrixWorld, n.boneInverses[o]),
          t.addScaledVector(Mh.copy(Vo).applyMatrix4(Xo), a);
      }
    }
...
class dl extends Mt {
  constructor(e = null, t = 1, n = 1, i, r, a, o, c, l = Pt, u = Pt, h, d) {
  ...
  fromJSON(e, t) {
    ...
    for (let n = 0, i = e.bones.length; n < i; n++) {
      ...
      a === void 0 &&
        ...
        (a = new hl())),
        this.bones.push(a),
        this.boneInverses.push(new De().fromArray(e.boneInverses[n]));
    }
...
class Th extends Et {
  constructor(e, t, n) {
    super(e, t),
      ...
      (this.instanceMatrix = new Da(new Float32Array(n * 16), 16)),
      (this.instanceColor = null),
  ...
  computeBoundingBox() {
    ...
    for (let n = 0; n < t; n++)
      this.getMatrixAt(n, vi),
        jo.copy(e.boundingBox).applyMatrix4(vi),
        this.boundingBox.union(jo);
  }
  computeBoundingSphere() {
    const e = this.geometry,
      t = this.count;
    ...
    for (let n = 0; n < t; n++)
      this.getMatrixAt(n, vi),
        ji.copy(e.boundingSphere).applyMatrix4(vi),
        this.boundingSphere.union(ji);
  }
  copy(e, t) {
    return (
      super.copy(e, t),
  ...
  raycast(e, t) {
    ...
    if (
      ...
      Ki.material !== void 0 &&
        (this.boundingSphere === null && this.computeBoundingSphere(),
        ji.copy(this.boundingSphere),
        ji.applyMatrix4(n),
        e.ray.intersectsSphere(ji) !== !1))
    )
      for (let r = 0; r < i; r++) {
        this.getMatrixAt(r, vi),
          Ko.multiplyMatrices(n, vi),
          (Ki.matrixWorld = Ko),
          Ki.raycast(e, Us);
...
class Qn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const i = Ur.subVectors(n, t).cross(bh.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || Ah.getNormalMatrix(e),
...
class Ja {
  ...
  setFromProjectionMatrix(e, t = En) {
    const n = this.planes,
      ...
      y = i[15];
    if (
      (n[0].setComponents(c - r, d - l, m - p, y - f).normalize(),
      n[1].setComponents(c + r, d + l, m + p, y + f).normalize(),
      n[2].setComponents(c + a, d + u, m + g, y + b).normalize(),
      n[3].setComponents(c - a, d - u, m - g, y - b).normalize(),
      n[4].setComponents(c - o, d - h, m - x, y - E).normalize(),
      t === En)
    )
      n[5].setComponents(c + o, d + h, m + x, y + E).normalize();
    else if (t === er) n[5].setComponents(o, h, x, E).normalize();
    else
      throw new Error(
  ...
  intersectsSprite(e) {
    ...
    return (
      (jn.radius = 0.7071067811865476 + t),
...
class Qa extends ut {
  ...
  computeLineDistances() {
    ...
    if (e.index === null) {
      ...
      for (let i = 1, r = t.count; i < r; i++)
        tr.fromBufferAttribute(t, i - 1),
          nr.fromBufferAttribute(t, i),
          (n[i] = n[i - 1]),
          (n[i] += tr.distanceTo(nr));
  ...
  raycast(e, t) {
    ...
    if (
      ...
      return;
    $o.copy(i).invert(), $i.copy(e.ray).applyMatrix4($o);
    ...
    if (u !== null) {
      ...
      for (let x = p, m = g - 1; x < m; x += l) {
        const f = u.getX(x),
          b = u.getX(x + 1),
          E = Os(this, e, $i, c, f, b, x);
        E && t.push(E);
      }
      if (this.isLineLoop) {
        const x = u.getX(g - 1),
          m = u.getX(p),
          f = Os(this, e, $i, c, x, m, g - 1);
        f && t.push(f);
      }
    } else {
      const p = Math.max(0, a.start),
      ...
      for (let x = p, m = g - 1; x < m; x += l) {
        const f = Os(this, e, $i, c, x, x + 1, x);
        f && t.push(f);
      }
      if (this.isLineLoop) {
        const x = Os(this, e, $i, c, g - 1, p, g - 1);
        x && t.push(x);
      }
    }
  }
...
function Os(s, e, t, n, i, r, a) {
  ...
  if (
    (tr.fromBufferAttribute(o, i),
    nr.fromBufferAttribute(o, r),
    t.distanceSqToSegment(tr, nr, Nr, Zo) > n)
  )
    return;
  Nr.applyMatrix4(s.matrixWorld);
  const l = e.ray.origin.distanceTo(Nr);
  if (!(l < e.near || l > e.far))
    return {
      distance: l,
      point: Zo.clone().applyMatrix4(s.matrixWorld),
      index: a,
      face: null,
      faceIndex: null,
      barycoord: null,
    ...
    if (e.index === null) {
      ...
      for (let i = 0, r = t.count; i < r; i += 2)
        Jo.fromBufferAttribute(t, i),
          Qo.fromBufferAttribute(t, i + 1),
          (n[i] = i === 0 ? 0 : n[i - 1]),
          (n[i + 1] = n[i] + Jo.distanceTo(Qo));
      e.setAttribute("lineDistance", new Yt(n, 1));
    } else
      console.warn(
...
class Ph extends ut {
  ...
  raycast(e, t) {
    ...
    if (
      ...
      return;
    ec.copy(i).invert(), Ua.copy(e.ray).applyMatrix4(ec);
    const o = r / ((this.scale.x + this.scale.y + this.scale.z) / 3),
      c = o * o,
      l = n.index,
    ...
    if (l !== null) {
      ...
      for (let g = d, x = p; g < x; g++) {
        const m = l.getX(g);
        zs.fromBufferAttribute(h, m), tc(zs, m, c, i, e, t, this);
      }
    } else {
      const d = Math.max(0, a.start),
        p = Math.min(h.count, a.start + a.count);
      for (let g = d, x = p; g < x; g++)
        zs.fromBufferAttribute(h, g), tc(zs, g, c, i, e, t, this);
    }
  }
  updateMorphTargets() {
    const t = this.geometry.morphAttributes,
...
class ml extends Mt {
  constructor(e, t, n = ii, i, r, a, o = Pt, c = Pt, l, u = as, h = 1) {
    if (u !== as && u !== os)
      throw new Error(
        "DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat"
      );
    const d = { width: e, height: t, depth: h };
    super(d, i, r, a, o, c, u, n, l),
  ...
  copy(e) {
    return (
      super.copy(e),
      (this.source = new Ka(Object.assign({}, e.image))),
...
class eo extends rn {
  constructor(
    ...
    b(),
      a === !1 && (e > 0 && E(!0), t > 0 && E(!1)),
      this.setIndex(u),
      this.setAttribute("position", new Yt(h, 3)),
      this.setAttribute("normal", new Yt(d, 3)),
      this.setAttribute("uv", new Yt(p, 2));
    function b() {
      const y = new I(),
        L = new I();
      let R = 0;
      ...
      for (let D = 0; D < i; D++)
        for (let S = 0; S < r; S++) {
          const M = x[S][D],
            ...
            H = x[S + 1][D + 1],
            z = x[S][D + 1];
          (e > 0 || S !== 0) && (u.push(M, C, z), (R += 3)),
            (t > 0 || S !== r - 1) && (u.push(C, H, z), (R += 3));
        }
      l.addGroup(f, R, 0), (f += R);
    }
    function E(y) {
      const L = g,
        R = new He(),
      ...
      const S = y === !0 ? e : t,
        M = y === !0 ? 1 : -1;
      for (let H = 1; H <= i; H++)
        h.push(0, m * M, 0), d.push(0, M, 0), p.push(0.5, 0.5), g++;
      const C = g;
      for (let H = 0; H <= i; H++) {
        const X = (H / i) * c + o,
          K = Math.cos(X),
      ...
      for (let H = 0; H < i; H++) {
        const z = L + H,
          X = C + H;
        y === !0 ? u.push(X, X + 1, z) : u.push(X + 1, X, z), (D += 3);
      }
      l.addGroup(f, D, y === !0 ? 1 : 2), (f += D);
    }
  }
  copy(e) {
    return (
...
class fs extends rn {
  constructor(e = 1, t = 1, n = 1, i = 1) {
    ...
    for (let f = 0; f < u; f++) {
      ...
      for (let E = 0; E < l; E++) {
        const y = E * h - r;
        g.push(y, -b, 0), x.push(0, 0, 1), m.push(E / o), m.push(1 - f / c);
      }
    }
    for (let f = 0; f < c; f++)
      for (let b = 0; b < o; b++) {
        const E = b + l * f,
          ...
          L = b + 1 + l * (f + 1),
          R = b + 1 + l * f;
        p.push(E, y, R), p.push(y, L, R);
      }
    this.setIndex(p),
      this.setAttribute("position", new Yt(g, 3)),
      this.setAttribute("normal", new Yt(x, 3)),
...
class Nh extends ps {
  constructor(e, t, n, i) {
    super(e, t, n, i),
      ...
      (this._weightNext = -0),
      (this._offsetNext = -0),
      (this.DefaultSettings_ = { endingStart: vo, endingEnd: vo });
  }
  ...
  interpolate_(e, t, n, i) {
    const r = this.resultBuffer,
      ...
      m = x * g,
      f = -d * m + 2 * d * x - d * g,
      b = (1 + d) * m + (-1.5 - 2 * d) * x + (-0.5 + d) * g + 1,
      E = (-1 - p) * m + (1.5 + p) * x + 0.5 * g,
      y = p * m - p * x;
    for (let L = 0; L !== o; ++L)
      r[L] = f * a[u + L] + b * a[l + L] + E * a[c + L] + y * a[h + L];
    return r;
  }
}
class Fh extends ps {
...
class an {
  ...
  static toJSON(e) {
    ...
    if (t.toJSON !== this.toJSON) n = t.toJSON(e);
      ...
      n = {
        name: e.name,
        times: Hs(e.times, Array),
        values: Hs(e.values, Array),
      };
...
zi.prototype.DefaultInterpolation = cs;
...
class Bh extends ps {
  ...
  interpolate_(e, t, n, i) {
    const r = this.resultBuffer,
      ...
      c = (n - t) / (i - t);
    let l = e * o;
    for (let u = l + o; l !== u; l += 4) Gn.slerpFlat(r, 0, a, l - o, a, l, c);
    return r;
  }
}
class Ni extends an {
...
Hi.prototype.DefaultInterpolation = cs;
...
class zh {
  ...
  static parse(e) {
    const t = [],
      n = e.tracks,
      i = 1 / (e.fps || 1);
    for (let a = 0, o = n.length; a !== o; ++a) t.push(kh(n[a]).scale(i));
  ...
  static toJSON(e) {
    ...
    for (let r = 0, a = n.length; r !== a; ++r) t.push(an.toJSON(n[r]));
    return i;
  }
  static CreateFromMorphTargetSequence(e, t, n, i) {
    ...
    for (let o = 0; o < r; o++) {
      ...
      (c = nc(c, 1, u)),
        ...
        a.push(
          new Ui(".morphTargetInfluences[" + t[o].name + "]", c, l).scale(1 / n)
        );
    }
  ...
  static parseAnimation(e, t) {
    ...
    const n = function (h, d, p, g, x) {
        if (p.length !== 0) {
          const m = [],
            f = [];
          gl(p, m, f, g), m.length !== 0 && x.push(new h(d, m, f));
        }
      },
      i = [],
      r = e.name || "default",
        ...
        if (d[0].morphTargets) {
          ...
          for (const x in p) {
            ...
            for (let b = 0; b !== d[g].morphTargets.length; ++b) {
              const E = d[g];
              m.push(E.time), f.push(E.morphTarget === x ? 1 : 0);
            }
            i.push(new Ui(".morphTargetInfluence[" + x + "]", m, f));
          }
          c = p.length * a;
        } else {
          const p = ".bones[" + t[h].name + "]";
          n(Fi, p + ".position", d, "pos", i),
            n(Ni, p + ".quaternion", d, "rot", i),
            n(Fi, p + ".scale", d, "scl", i);
        }
    }
...
function kh(s) {
  ...
  if (s.times === void 0) {
    const t = [],
      n = [];
    gl(s.keys, t, n, "value"), (s.times = t), (s.values = n);
  }
  ...
  load(e, t, n, i) {
    ...
    if (a !== void 0) {
      if (a.complete === !0)
        ...
        let h = Mi.get(a);
        h === void 0 && ((h = []), Mi.set(a, h)),
          h.push({ onLoad: t, onError: i });
      }
      return a;
    }
    const o = us("img");
...
class to {
  ...
  updateMatrices(e) {
    const t = this.camera,
      n = this.matrix;
    ic.setFromMatrixPosition(e.matrixWorld),
      t.position.copy(ic),
      sc.setFromMatrixPosition(e.target.matrixWorld),
      t.lookAt(sc),
      t.updateMatrixWorld(),
      Fr.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse),
      this._frustum.setFromProjectionMatrix(Fr),
...
class jh extends to {
  ...
  updateMatrices(e, t = 0) {
    ...
    r !== n.far && ((n.far = r), n.updateProjectionMatrix()),
      ...
      n.position.copy(Zi),
      Or.copy(n.position),
      Or.add(this._cubeDirections[t]),
      n.up.copy(this._cubeUps[t]),
      n.lookAt(Or),
      n.updateMatrixWorld(),
      i.makeTranslation(-Zi.x, -Zi.y, -Zi.z),
      rc.multiplyMatrices(n.projectionMatrix, n.matrixWorldInverse),
      this._frustum.setFromProjectionMatrix(rc);
  }
}
class vl extends ar {
...
class Jh extends ki {
  ...
  load(e, t, n, i) {
    e === void 0 && (e = ""),
      ...
      (e = this.manager.resolveURL(e));
    const r = this,
      a = bn.get(`image-bitmap:${e}`);
    if (a !== void 0) {
      if ((r.manager.itemStart(e), a.then)) {
        a.then((l) => {
          if (Br.has(a) === !0)
            i && i(Br.get(a)), r.manager.itemError(e), r.manager.itemEnd(e);
    ...
    const c = fetch(e, o)
      ...
      .then(function (l) {
        return (
          bn.add(`image-bitmap:${e}`, l), t && t(l), r.manager.itemEnd(e), l
        );
      })
      .catch(function (l) {
        i && i(l),
          Br.set(c, l),
          bn.remove(`image-bitmap:${e}`),
          r.manager.itemError(e),
          r.manager.itemEnd(e);
      });
    bn.add(`image-bitmap:${e}`, c), r.manager.itemStart(e);
  }
}
class Qh extends Rt {
  constructor(e = []) {
...
const io = "\\[\\]\\.:\\/",
  ...
  so = "[^" + io + "]",
  nd = "[^" + io.replace("\\.", "") + "]",
  id = /((?:WC+[\/:])*)/.source.replace("WC", so),
  sd = /(WCOD+)?/.source.replace("WCOD", nd),
  rd = /(?:\.(WC+)(?:\[(.+)\])?)?/.source.replace("WC", so),
  ad = /\.(WC+)(?:\[(.+)\])?/.source.replace("WC", so),
  od = new RegExp("^" + id + sd + rd + ad + "$"),
...
class ud {
  ...
  intersectObject(e, t = !0, n = []) {
    return Na(e, this, n, t), n.sort(oc), n;
  }
...
function Na(s, e, t, n) {
  ...
  if (
    ...
    const r = s.children;
    for (let a = 0, o = r.length; a < o; a++) Na(r[a], e, t, !0);
  }
}
function cc(s, e, t, n) {
  const i = hd(n);
...
function dd(s) {
  ...
  function n(o, c, l) {
    const u = c.array,
      h = c.updateRanges;
    if ((s.bindBuffer(l, o), h.length === 0)) s.bufferSubData(l, 0, u);
    else {
      ...
      for (let p = 1; p < h.length; p++) {
        const g = h[d],
          x = h[p];
        x.start <= g.start + g.count + 1
          ? (g.count = Math.max(g.count, x.start + x.count - g.start))
          : (++d, (h[d] = x));
      }
      h.length = d + 1;
...
#endif`,
  Ed = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
...
vec3 BRDF_BlinnPhong( const in vec3 lightDir, const in vec3 viewDir, const in vec3 normal, const in vec3 specularColor, const in float shininess ) {
  ...
  Rd = `#if NUM_CLIPPING_PLANES > 0
	...
	#endif
#endif`,
  Cd = `#if NUM_CLIPPING_PLANES > 0
	varying vec3 vClipPosition;
	uniform vec4 clippingPlanes[ NUM_CLIPPING_PLANES ];
#endif`,
  Pd = `#if NUM_CLIPPING_PLANES > 0
	varying vec3 vClipPosition;
#endif`,
...
#endif`,
  Bd = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
#endif`,
  Gd = "gl_FragColor = linearToOutputTexel( gl_FragColor );",
  Wd = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
#define RE_IndirectDiffuse		RE_IndirectDiffuse_Toon`,
  lf = `BlinnPhongMaterial material;
material.diffuseColor = diffuseColor.rgb;
...
IncidentLight directLight;
  ...
  pf = `#if defined( RE_IndirectDiffuse )
	...
	#endif
#endif`,
  mf = `#if defined( RE_IndirectDiffuse )
	RE_IndirectDiffuse( irradiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif
#if defined( RE_IndirectSpecular )
	RE_IndirectSpecular( radiance, iblIrradiance, clearcoatRadiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif`,
  gf = `#if defined( USE_LOGDEPTHBUF )
	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;
#endif`,
  _f = `#if defined( USE_LOGDEPTHBUF )
	uniform float logDepthBufFC;
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
  xf = `#ifdef USE_LOGDEPTHBUF
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
  vf = `#ifdef USE_LOGDEPTHBUF
...
#endif`,
  Sf = `#if defined( USE_MAP ) || defined( USE_ALPHAMAP )
  ...
  Ef = `#if defined( USE_POINTS_UV )
	...
	uniform sampler2D alphaMap;
#endif`,
  Tf = `float metalnessFactor = metalness;
...
#endif`,
  Pf = `#ifdef USE_MORPHTARGETS
	transformed *= morphTargetBaseInfluence;
	for ( int i = 0; i < MORPHTARGETS_COUNT; i ++ ) {
		if ( morphTargetInfluences[ i ] != 0.0 ) transformed += getMorph( gl_VertexID, i, 0 ).xyz * morphTargetInfluences[ i ];
	}
#endif`,
  Lf = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
#endif`,
  Of = `#ifdef USE_CLEARCOAT
	vec3 clearcoatNormal = nonPerturbedNormal;
#endif`,
  Bf = `#ifdef USE_CLEARCOAT_NORMALMAP
	vec3 clearcoatMapN = texture2D( clearcoatNormalMap, vClearcoatNormalMapUv ).xyz * 2.0 - 1.0;
	clearcoatMapN.xy *= clearcoatNormalScale;
	clearcoatNormal = normalize( tbn2 * clearcoatMapN );
#endif`,
  zf = `#ifdef USE_CLEARCOATMAP
...
gl_FragColor = vec4( outgoingLight, diffuseColor.a );`,
  Vf = `vec3 packNormalToRGB( const in vec3 normal ) {
...
#endif`,
  Wf = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
gl_Position = projectionMatrix * mvPosition;`,
...
#endif`,
  Yf = `float roughnessFactor = roughness;
  ...
  $f = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  Zf = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  up = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	varying vec2 vUv;
#endif
#ifdef USE_MAP
	...
	varying vec2 vThicknessMapUv;
#endif`,
  hp = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	vUv = vec3( uv, 1 ).xy;
#endif
#ifdef USE_MAP
...
void main() {
  ...
  Fe = {
    ...
    color_vertex: Nd,
    common: Fd,
    cube_uv_reflection_fragment: Od,
    defaultnormal_vertex: Bd,
    ...
    lights_lambert_pars_fragment: sf,
    ...
    lights_fragment_begin: ff,
    lights_fragment_maps: pf,
    lights_fragment_end: mf,
    logdepthbuf_fragment: gf,
    logdepthbuf_pars_fragment: _f,
    logdepthbuf_pars_vertex: xf,
    ...
    morphnormal_vertex: Rf,
    morphtarget_pars_vertex: Cf,
    morphtarget_vertex: Pf,
    normal_fragment_begin: Lf,
    normal_fragment_maps: If,
    normal_pars_fragment: Df,
    normal_pars_vertex: Uf,
    normal_vertex: Nf,
    normalmap_pars_fragment: Ff,
    clearcoat_normal_fragment_begin: Of,
    ...
    shadowmap_pars_vertex: $f,
    shadowmap_vertex: Zf,
    shadowmask_pars_fragment: Jf,
    skinbase_vertex: Qf,
    skinning_pars_vertex: ep,
    skinning_vertex: tp,
    skinnormal_vertex: np,
    specularmap_fragment: ip,
    specularmap_pars_fragment: sp,
    tonemapping_fragment: rp,
    tonemapping_pars_fragment: ap,
    ...
    meshphong_vert: Np,
    meshphong_frag: Fp,
    meshphysical_vert: Op,
    meshphysical_frag: Bp,
    meshtoon_vert: zp,
    meshtoon_frag: Hp,
    points_vert: kp,
    points_frag: Vp,
...
on.physical = {
  uniforms: wt([
    on.standard.uniforms,
    {
      ...
      attenuationColor: { value: new Le(0) },
      specularColor: { value: new Le(1, 1, 1) },
...
function Kp(s, e, t, n, i, r, a) {
  ...
  function g(E) {
    ...
    return (
      y && y.isTexture && (y = (E.backgroundBlurriness > 0 ? t : e).get(y)), y
    );
  }
  function x(E) {
    let y = !1;
    const L = g(E);
    L === null ? f(o, c) : L && L.isColor && (f(L, 1), (y = !0));
  ...
  function m(E, y) {
    const L = g(y);
    L && (L.isCubeTexture || L.mapping === sr)
      ? (u === void 0 &&
          ((u = new Et(
            new Bi(1, 1, 1),
            new Vn({
              name: "BackgroundCubeMaterial",
              uniforms: Di(on.backgroundCube.uniforms),
          ...
          (u.onBeforeRender = function (R, A, D) {
        ...
        L.isCubeTexture &&
          ...
          (($n.y *= -1), ($n.z *= -1)),
        (u.material.uniforms.envMap.value = L),
        ...
        u.material.uniforms.backgroundRotation.value.setFromMatrix4(
          Yp.makeRotationFromEuler($n)
        ),
        (u.material.toneMapped = Ve.getTransfer(L.colorSpace) !== Qe),
        (h !== L || d !== L.version || p !== s.toneMapping) &&
      ...
      : L &&
        ...
        (l === void 0 &&
          ((l = new Et(
            ...
            new Vn({
              ...
              uniforms: Di(on.background.uniforms),
        ...
        (l.material.toneMapped = Ve.getTransfer(L.colorSpace) !== Qe),
  ...
  function f(E, y) {
    E.getRGB(ks, cl(s)), n.buffers.color.setClear(ks.r, ks.g, ks.b, y, a);
  }
  function b() {
...
function jp(s, e) {
  ...
  let r = i,
    a = !1;
  function o(M, C, H, z, X) {
    let K = !1;
    const G = h(z, H, C);
    r !== G && ((r = G), l(r.object)),
      (K = p(M, z, H, X)),
      K && g(M, z, H, X),
      X !== null && e.update(X, s.ELEMENT_ARRAY_BUFFER),
      (K || a) &&
        ((a = !1),
        y(M, C, H, z),
        X !== null && s.bindBuffer(s.ELEMENT_ARRAY_BUFFER, e.get(X).buffer));
  }
  function c() {
  ...
  function h(M, C, H) {
    ...
    K === void 0 && ((K = {}), (X[C.id] = K));
    let G = K[z];
    return G === void 0 && ((G = d(c())), (K[z] = G)), G;
  }
  function d(M) {
    const C = [],
      H = [],
      z = [];
    for (let X = 0; X < t; X++) (C[X] = 0), (H[X] = 0), (z[X] = 0);
    return {
      geometry: null,
      program: null,
      wireframe: !1,
        ...
        if (
          (ye === void 0 &&
            (k === "instanceMatrix" &&
              M.instanceMatrix &&
              (ye = M.instanceMatrix),
            k === "instanceColor" && M.instanceColor && (ye = M.instanceColor)),
          he === void 0 || he.attribute !== ye || (ye && he.data !== ye.data))
        )
          return !0;
        G++;
      }
      ...
      if (Z[k].location >= 0) {
        ...
        he === void 0 &&
          (k === "instanceMatrix" &&
            M.instanceMatrix &&
            (he = M.instanceMatrix),
          k === "instanceColor" && M.instanceColor && (he = M.instanceColor));
        const ye = {};
        (ye.attribute = he),
          he && he.data && (ye.data = he.data),
          (X[k] = ye),
          G++;
      }
  ...
  function x() {
    ...
    for (let C = 0, H = M.length; C < H; C++) M[C] = 0;
  }
  function m(M) {
    f(M, 0);
  }
  function f(M, C) {
    ...
    (H[M] = 1),
      z[M] === 0 && (s.enableVertexAttribArray(M), (z[M] = 1)),
      X[M] !== C && (s.vertexAttribDivisor(M, C), (X[M] = C));
  }
  function b() {
    const M = r.newAttributes,
      C = r.enabledAttributes;
    for (let H = 0, z = C.length; H < z; H++)
      C[H] !== M[H] && (s.disableVertexAttribArray(H), (C[H] = 0));
  }
  function E(M, C, H, z, X, K, G) {
    G === !0
      ? s.vertexAttribIPointer(M, C, H, X, K)
      : s.vertexAttribPointer(M, C, H, z, X, K);
  }
  function y(M, C, H, z) {
    x();
        ...
        if (
          (oe === void 0 &&
            (Z === "instanceMatrix" &&
              M.instanceMatrix &&
              (oe = M.instanceMatrix),
            Z === "instanceColor" && M.instanceColor && (oe = M.instanceColor)),
          oe !== void 0)
        ) {
          ...
          const tt = Oe.buffer,
            ...
            ve = q === s.INT || q === s.UNSIGNED_INT || oe.gpuType === Ha;
          if (oe.isInterleavedBufferAttribute) {
            const ce = oe.data,
              Me = ce.stride,
              Xe = oe.offset;
            if (ce.isInstancedInterleavedBuffer) {
              for (let we = 0; we < k.locationSize; we++)
                f(k.location + we, ce.meshPerAttribute);
              M.isInstancedMesh !== !0 &&
                z._maxInstanceCount === void 0 &&
                (z._maxInstanceCount = ce.meshPerAttribute * ce.count);
            } else
              for (let we = 0; we < k.locationSize; we++) m(k.location + we);
  ...
  function L() {
    ...
    for (const M in n) {
      ...
      for (const H in C) {
        const z = C[H];
        for (const X in z) u(z[X].object), delete z[X];
        delete C[H];
      }
      delete n[M];
    }
...
function Zp(s, e, t, n) {
  ...
  function a(A) {
    return !(
      A !== qt &&
      n.convert(A) !== s.getParameter(s.IMPLEMENTATION_COLOR_READ_FORMAT)
    );
  }
  function o(A) {
    const D =
    ...
    return !(
      A !== ln &&
      n.convert(A) !== s.getParameter(s.IMPLEMENTATION_COLOR_READ_TYPE) &&
      A !== nn &&
      !D
    );
  }
  ...
  const h = t.logarithmicDepthBuffer === !0,
    ...
    p = s.getParameter(s.MAX_TEXTURE_IMAGE_UNITS),
    g = s.getParameter(s.MAX_VERTEX_TEXTURE_IMAGE_UNITS),
    x = s.getParameter(s.MAX_TEXTURE_SIZE),
    m = s.getParameter(s.MAX_CUBE_MAP_TEXTURE_SIZE),
    f = s.getParameter(s.MAX_VERTEX_ATTRIBS),
    b = s.getParameter(s.MAX_VERTEX_UNIFORM_VECTORS),
    E = s.getParameter(s.MAX_VARYING_VECTORS),
    y = s.getParameter(s.MAX_FRAGMENT_UNIFORM_VECTORS),
    L = g > 0,
    R = s.getParameter(s.MAX_SAMPLES);
  return {
    isWebGL2: !0,
    getMaxAnisotropy: r,
    getMaxPrecision: c,
  ...
  (this.uniform = c),
    ...
    (this.setState = function (h, d, p) {
      ...
      if (!i || g === null || g.length === 0 || (r && !m)) r ? u(null) : l();
        ...
        (c.value = y), (y = u(g, d, E, p));
        for (let L = 0; L !== E; ++L) y[L] = t[L];
        (f.clippingState = y),
  ...
  function u(h, d, p, g) {
    ...
    if (x !== 0) {
      if (((m = c.value), g !== !0 || m === null)) {
        ...
        for (let E = 0, y = p; E !== x; ++E, y += 4)
          a.copy(h[E]).applyMatrix4(b, o),
...
function Qp(s) {
  let e = new WeakMap();
  function t(a, o) {
    return o === ia ? (a.mapping = Ci) : o === sa && (a.mapping = Pi), a;
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
class dc {
  ...
  fromScene(e, t = 0, n = 0.1, i = 100, r = {}) {
    const { size: a = 256, position: o = em } = r;
    (Hr = this._renderer.getRenderTarget()),
      (kr = this._renderer.getActiveCubeFace()),
      (Vr = this._renderer.getActiveMipmapLevel()),
      (Gr = this._renderer.xr.enabled),
  ...
  _cleanup(e) {
    this._renderer.setRenderTarget(Hr, kr, Vr),
      (this._renderer.xr.enabled = Gr),
      (e.scissorTest = !1),
      Vs(e, 0, 0, e.width, e.height);
  }
  _fromTexture(e, t) {
    e.mapping === Ci || e.mapping === Pi
      ? this._setSize(
  ...
  _sceneToCubeUV(e, t, n, i, r) {
    const c = new Rt(90, 1, t, n),
      l = [1, -1, 1, 1, 1, 1],
      u = [1, 1, 1, -1, -1, -1],
      h = this._renderer,
      d = h.autoClear,
      p = h.toneMapping;
    h.getClearColor(uc), (h.toneMapping = zn), (h.autoClear = !1);
    const g = new Tn({
    ...
    f
      ? f.isColor && (g.color.copy(f), (e.background = null), (m = !0))
      : (g.color.copy(uc), (m = !0));
    for (let b = 0; b < 6; b++) {
      const E = b % 3;
      E === 0
  ...
  _textureToCubeUV(e, t) {
    ...
    const r = i ? this._cubemapMaterial : this._equirectMaterial,
      a = new Et(this._lodPlanes[0], r),
      o = r.uniforms;
    o.envMap.value = e;
    const c = this._cubeSize;
    Vs(t, 0, 0, 3 * c, 2 * c), n.setRenderTarget(t), n.render(a, zr);
  }
  _applyPMREM(e) {
  ...
  _halfBlur(e, t, n, i, r, a, o) {
    ...
    const u = 3,
      h = new Et(this._lodPlanes[i], l),
      d = l.uniforms,
      p = this._sizeLods[n] - 1,
      g = isFinite(r) ? Math.PI / (2 * p) : (2 * Math.PI) / (2 * ni - 1),
      x = r / g,
      m = isFinite(r) ? 1 + Math.floor(u * x) : ni;
    m > ni &&
      console.warn(
        `sigmaRadians, ${r}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${ni}`
      );
    const f = [];
    let b = 0;
    for (let A = 0; A < ni; ++A) {
    ...
    const y = this._sizeLods[i],
      L = 3 * y * (i > E - Si ? i - E + Si : 0),
      R = 4 * (this._cubeSize - y);
    Vs(t, L, R, 3 * y, 2 * y), c.setRenderTarget(t), c.render(h, zr);
  }
}
function tm(s) {
  const e = [],
    ...
    n = [];
  let i = s;
  const r = s - Si + 1 + lc.length;
  for (let a = 0; a < r; a++) {
    const o = Math.pow(2, i);
    t.push(o);
    let c = 1 / o;
    a > s - Si ? (c = lc[a - s + Si - 1]) : a === 0 && (c = 0), n.push(c);
    const l = 1 / (o - 2),
      u = -l,
      h = 1 + l,
    ...
    for (let R = 0; R < p; R++) {
      ...
      b.set(S, x * g * R), E.set(d, m * g * R);
      const M = [R, R, R, R, R, R];
      y.set(M, f * g * R);
    }
    const L = new rn();
    L.setAttribute("position", new Lt(b, x)),
      L.setAttribute("uv", new Lt(E, m)),
      L.setAttribute("faceIndex", new Lt(y, f)),
      e.push(L),
      i > Si && i--;
  }
...
function sm(s) {
  ...
  return {
    ...
    get: function (n) {
      ...
      return (
        i === null &&
          Ti("THREE.WebGLRenderer: " + n + " extension not supported."),
        i
      );
    },
  };
...
function cm(s, e, t) {
  ...
  function r(a, o, c) {
    ...
    if (d === void 0 || d.count !== h) {
      ...
      let y = 0;
      g === !0 && (y = 1), x === !0 && (y = 2), m === !0 && (y = 3);
      let L = o.attributes.position.count * y,
        R = 1;
      L > e.maxTextureSize &&
        ((R = Math.ceil(L / e.maxTextureSize)), (L = e.maxTextureSize));
      const A = new Float32Array(L * R * 4 * h),
        D = new sl(A, L, R, h);
      (D.type = nn), (D.needsUpdate = !0);
      const S = y * 4;
      for (let C = 0; C < h; C++) {
        const H = f[C],
          z = b[C],
        ...
        for (let G = 0; G < H.count; G++) {
          ...
          g === !0 &&
            ...
            x === !0 &&
              ...
              (A[K + Z + 7] = 0)),
            m === !0 &&
              (i.fromBufferAttribute(X, G),
              (A[K + Z + 8] = i.x),
              (A[K + Z + 9] = i.y),
              (A[K + Z + 10] = i.z),
              (A[K + Z + 11] = X.itemSize === 4 ? i.w : 1));
        }
      }
      (d = { count: h, texture: D, size: new He(L, R) }),
        n.set(o, d),
...
const yl = new Mt(),
  ...
  _c = [],
  xc = [],
  vc = new Float32Array(16),
  Mc = new Float32Array(9),
...
function Vi(s, e, t) {
  ...
  const i = e * t;
  let r = _c[i];
  if ((r === void 0 && ((r = new Float32Array(i)), (_c[i] = r)), e !== 0)) {
    n.toArray(r, 0);
...
function pm(s, e) {
  ...
  if (n === void 0) {
    ...
    if (gt(t, n)) return;
    yc.set(n), s.uniformMatrix2fv(this.addr, !1, yc), _t(t, n);
  }
}
function mm(s, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (gt(t, n)) return;
    Mc.set(n), s.uniformMatrix3fv(this.addr, !1, Mc), _t(t, n);
  }
}
function gm(s, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (gt(t, n)) return;
    vc.set(n), s.uniformMatrix4fv(this.addr, !1, vc), _t(t, n);
  }
}
function _m(s, e) {
  const t = this.cache;
...
function Am(s, e, t) {
  const n = this.cache,
    i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), (n[0] = i)),
    t.setTexture3D(e || El, i);
}
function wm(s, e, t) {
  const n = this.cache,
    i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), (n[0] = i)),
    t.setTextureCube(e || Tl, i);
}
function Rm(s, e, t) {
  const n = this.cache,
    i = t.allocateTextureUnit();
  n[0] !== i && (s.uniform1i(this.addr, i), (n[0] = i)),
    t.setTexture2DArray(e || Sl, i);
}
function Cm(s) {
  switch (s) {
    case 5126:
...
function Xm(s, e, t) {
  ...
  for (let a = 0; a !== i; ++a) t.setTexture2D(e[a] || yl, r[a]);
}
function qm(s, e, t) {
  const n = this.cache,
    i = e.length,
    r = or(t, i);
  gt(n, r) || (s.uniform1iv(this.addr, r), _t(n, r));
  for (let a = 0; a !== i; ++a) t.setTexture3D(e[a] || El, r[a]);
}
function Ym(s, e, t) {
  const n = this.cache,
    i = e.length,
    r = or(t, i);
  gt(n, r) || (s.uniform1iv(this.addr, r), _t(n, r));
  for (let a = 0; a !== i; ++a) t.setTextureCube(e[a] || Tl, r[a]);
}
function Km(s, e, t) {
  const n = this.cache,
    i = e.length,
    r = or(t, i);
  gt(n, r) || (s.uniform1iv(this.addr, r), _t(n, r));
  for (let a = 0; a !== i; ++a) t.setTexture2DArray(e[a] || Sl, r[a]);
}
function jm(s) {
  switch (s) {
    case 5126:
...
function Qm(s, e, t) {
  ...
  for (Wr.lastIndex = 0; ; ) {
    ...
    if ((c && (o = o | 0), l === void 0 || (l === "[" && a + 2 === i))) {
      Sc(t, l === void 0 ? new $m(o, s, e) : new Zm(o, s, e));
      break;
    } else {
      let h = t.map[o];
      h === void 0 && ((h = new Jm(o)), Sc(t, h)), (t = h);
    }
  }
}
class Zs {
...
const Tc = new Ue();
function ig(s) {
  Ve._getMatrix(Tc, Ve.workingColorSpace, s);
...
function mg(s) {
  ...
  return (
    s.shadowMapType === kc
      ...
      : s.shadowMapType === Mn && (e = "SHADOWMAP_TYPE_VSM"),
    e
  );
}
function gg(s) {
...
`)),
      (f = [
        ...
        t.toneMapping !== zn ? Fe.tonemapping_pars_fragment : "",
        t.toneMapping !== zn ? rg("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const E = b + m + a,
    y = b + f + o,
    L = Ec(i, i.VERTEX_SHADER, E),
    R = Ec(i, i.FRAGMENT_SHADER, y);
  i.attachShader(x, L),
    i.attachShader(x, R),
  ...
  function A(C) {
    if (s.debug.checkShaderErrors) {
      const H = i.getProgramInfoLog(x).trim(),
        z = i.getShaderInfoLog(L).trim(),
        X = i.getShaderInfoLog(R).trim();
      let K = !0,
        G = !0;
      if (i.getProgramParameter(x, i.LINK_STATUS) === !1)
        if (((K = !1), typeof s.debug.onShaderError == "function"))
          s.debug.onShaderError(i, x, L, R);
        else {
          const Z = bc(i, L, "vertex"),
            k = bc(i, R, "fragment");
          console.error(
...
` +
      ...
      G &&
        (C.diagnostics = {
          ...
          fragmentShader: { log: X, prefix: f },
        });
    }
    i.deleteShader(L), i.deleteShader(R), (D = new Zs(i, x)), (S = lg(i, x));
  }
  let D;
  ...
  return (
    (this.isReady = function () {
      return M === !1 && (M = i.getProgramParameter(x, eg)), M;
    }),
...
class Sg {
  ...
  _getShaderStage(e) {
    ...
    let n = t.get(e);
    return n === void 0 && ((n = new Eg(e)), t.set(e, n)), n;
  }
}
class Eg {
  constructor(e) {
    (this.id = yg++), (this.code = e), (this.usedTimes = 0);
  }
}
function Tg(s, e, t, n, i, r, a) {
  const o = new ja(),
    c = new Sg(),
    l = new Set(),
    u = [],
  ...
  function m(S, M, C, H, z) {
    const X = H.fog,
      K = z.geometry,
      G = S.isMeshStandardMaterial ? H.environment : null,
      Z = (S.isMeshStandardMaterial ? t : e).get(S.envMap || G),
      k = Z && Z.mapping === sr ? Z.image.height : null,
      oe = g[S.type];
    S.precision !== null &&
    ...
    if (oe) {
      const je = on[oe];
      (tt = je.vertexShader), (q = je.fragmentShader);
    } else
      (tt = S.vertexShader),
        (q = S.fragmentShader),
        c.update(S),
        (te = c.getVertexShaderID(S)),
        (ve = c.getFragmentShaderID(S));
    const ce = s.getRenderTarget(),
      Me = s.state.buffers.depth.getReversed(),
      Xe = z.isInstancedMesh === !0,
      ...
      W = S.sheen > 0,
      j = S.transmission > 0,
      V = ft && !!S.anisotropyMap,
      _e = T && !!S.clearcoatMap,
      se = T && !!S.clearcoatNormalMap,
      me = T && !!S.clearcoatRoughnessMap,
      xe = F && !!S.iridescenceMap,
      $ = F && !!S.iridescenceThicknessMap,
      le = W && !!S.sheenColorMap,
      Ae = W && !!S.sheenRoughnessMap,
      be = !!S.specularMap,
      ne = !!S.specularColorMap,
      Pe = !!S.specularIntensityMap,
      P = j && !!S.transmissionMap,
      re = j && !!S.thicknessMap,
      J = !!S.gradientMap,
      de = !!S.alphaMap,
      Q = S.alphaTest > 0,
    ...
    const st = {
      ...
      instancing: Xe,
      instancingColor: Xe && z.instanceColor !== null,
      instancingMorph: Xe && z.morphTexture !== null,
      ...
      emissiveMap: Ge,
      normalMapObjectSpace: it && S.normalMapType === vu,
      normalMapTangentSpace: it && S.normalMapType === tl,
      metalnessMap: Ee,
      roughnessMap: Ne,
      anisotropy: ft,
      anisotropyMap: V,
      ...
      gradientMap: J,
      opaque:
        S.transparent === !1 && S.blending === Ei && S.alphaToCoverage === !1,
      alphaMap: de,
      alphaTest: Q,
      alphaHash: Y,
      combine: S.combine,
      mapUv: ot && x(S.map.channel),
      aoMapUv: w && x(S.aoMap.channel),
      lightMapUv: Tt && x(S.lightMap.channel),
      bumpMapUv: Ye && x(S.bumpMap.channel),
      normalMapUv: it && x(S.normalMap.channel),
      displacementMapUv: ge && x(S.displacementMap.channel),
      emissiveMapUv: Ge && x(S.emissiveMap.channel),
      metalnessMapUv: Ee && x(S.metalnessMap.channel),
      roughnessMapUv: Ne && x(S.roughnessMap.channel),
      anisotropyMapUv: V && x(S.anisotropyMap.channel),
      clearcoatMapUv: _e && x(S.clearcoatMap.channel),
      clearcoatNormalMapUv: se && x(S.clearcoatNormalMap.channel),
      clearcoatRoughnessMapUv: me && x(S.clearcoatRoughnessMap.channel),
      iridescenceMapUv: xe && x(S.iridescenceMap.channel),
      iridescenceThicknessMapUv: $ && x(S.iridescenceThicknessMap.channel),
      sheenColorMapUv: le && x(S.sheenColorMap.channel),
      sheenRoughnessMapUv: Ae && x(S.sheenRoughnessMap.channel),
      specularMapUv: be && x(S.specularMap.channel),
      specularColorMapUv: ne && x(S.specularColorMap.channel),
      specularIntensityMapUv: Pe && x(S.specularIntensityMap.channel),
      transmissionMapUv: P && x(S.transmissionMap.channel),
      thicknessMapUv: re && x(S.thicknessMap.channel),
      alphaMapUv: de && x(S.alphaMap.channel),
      vertexTangents: !!K.attributes.tangent && (it || ft),
      vertexColors: S.vertexColors,
      vertexAlphas:
        S.vertexColors === !0 &&
        !!K.attributes.color &&
        K.attributes.color.itemSize === 4,
      pointsUvs: z.isPoints === !0 && !!K.attributes.uv && (ot || de),
      fog: !!X,
      useFog: S.fog === !0,
      ...
      decodeVideoTexture:
        ...
        Ve.getTransfer(S.map.colorSpace) === Qe,
      decodeVideoTextureEmissive:
        Ge &&
        S.emissiveMap.isVideoTexture === !0 &&
        Ve.getTransfer(S.emissiveMap.colorSpace) === Qe,
      ...
      extensionMultiDraw:
        ((fe && S.extensions.multiDraw === !0) || we) &&
    ...
    return (
      (st.vertexUv1s = l.has(1)),
      (st.vertexUv2s = l.has(2)),
      (st.vertexUv3s = l.has(3)),
      l.clear(),
      st
    );
  }
  function f(S) {
    ...
    if (
      ...
      for (const C in S.defines) M.push(C), M.push(S.defines[C]);
    return (
      S.isRawShaderMaterial === !1 &&
        (b(M, S), E(M, S), M.push(s.outputColorSpace)),
  ...
  function L(S, M) {
    ...
    return C === void 0 && ((C = new Mg(s, M, S, r)), u.push(C)), C;
  }
  function R(S) {
    if (--S.usedTimes === 0) {
      const M = u.indexOf(S);
...
function Lc() {
  ...
  function l(h, d) {
    t.length > 1 && t.sort(h || Ag),
      n.length > 1 && n.sort(d || Pc),
      i.length > 1 && i.sort(d || Pc);
  }
  function u() {
    ...
    get: function (e) {
      ...
      switch (e.type) {
        case "DirectionalLight":
          t = { direction: new I(), color: new Le() };
          break;
        case "SpotLight":
          t = {
            position: new I(),
          ...
          break;
        case "PointLight":
          t = { position: new I(), color: new Le(), distance: 0, decay: 0 };
          break;
        case "HemisphereLight":
          t = { direction: new I(), skyColor: new Le(), groundColor: new Le() };
          break;
        case "RectAreaLight":
          t = {
            color: new Le(),
  ...
  function o(l) {
    ...
    for (let S = 0, M = l.length; S < M; S++) {
      const C = l[S],
        ...
        z = C.intensity,
        X = C.distance,
        K = C.shadow && C.shadow.map ? C.shadow.map.texture : null;
      if (C.isAmbientLight) (u += H.r * z), (h += H.g * z), (d += H.b * z);
        ...
        G.position.setFromMatrixPosition(C.matrixWorld),
          G.color.copy(H).multiplyScalar(z),
          (G.distance = X),
        ...
        const G = e.get(C);
        G.skyColor.copy(C.color).multiplyScalar(z),
          G.groundColor.copy(C.groundColor).multiplyScalar(z),
          (n.hemi[f] = G),
          f++;
      }
    }
    ...
    (D.directionalLength !== p ||
      ...
      (n.spotLightMatrix.length = y + L - R),
  ...
  function c(l, u) {
    ...
    for (let f = 0, b = l.length; f < b; f++) {
      ...
      if (E.isDirectionalLight) {
        ...
        y.direction.setFromMatrixPosition(E.matrixWorld),
        ...
        y.position.setFromMatrixPosition(E.matrixWorld),
          ...
          r.premultiply(m),
          a.extractRotation(r),
          y.halfWidth.set(E.width * 0.5, 0, 0),
          y.halfHeight.set(0, E.height * 0.5, 0),
  ...
  this.render = function (R, A, D) {
    ...
    for (let K = 0, G = R.length; K < G; K++) {
      ...
      if (
        ...
        (i.x > u || i.y > u) &&
          (i.x > u &&
            ((r.x = Math.floor(u / oe.x)),
            (i.x = r.x * oe.x),
            (k.mapSize.x = r.x)),
          i.y > u &&
            ((r.y = Math.floor(u / oe.y)),
            (i.y = r.y * oe.y),
            (k.mapSize.y = r.y))),
        k.map === null || z === !0 || X === !0)
      ) {
        const ye = this.type !== Mn ? { minFilter: Pt, magFilter: Pt } : {};
        k.map !== null && k.map.dispose(),
          (k.map = new si(i.x, i.y, ye)),
          (k.map.texture.name = Z.name + ".shadowMap"),
          k.camera.updateProjectionMatrix();
      }
      s.setRenderTarget(k.map), s.clear();
      const he = k.getViewportCount();
      for (let ye = 0; ye < he; ye++) {
        const Oe = k.getViewport(ye);
        a.set(r.x * Oe.x, r.y * Oe.y, r.x * Oe.z, r.y * Oe.w),
          H.viewport(a),
          k.updateMatrices(Z, ye),
          (n = k.getFrustum()),
          y(A, D, k.camera, Z, this.type);
      }
      k.isPointLightShadow !== !0 && this.type === Mn && b(k, D),
        (k.needsUpdate = !1);
    }
    (f = this.type), (m.needsUpdate = !1), s.setRenderTarget(S, M, C);
  };
  function b(R, A) {
    const D = e.update(x);
    d.defines.VSM_SAMPLES !== R.blurSamples &&
      ...
      (d.needsUpdate = !0),
      (p.needsUpdate = !0)),
      R.mapPass === null && (R.mapPass = new si(i.x, i.y)),
      ...
      s.clear(),
      s.renderBufferDirect(A, null, D, d, x, null),
      ...
      s.clear(),
      s.renderBufferDirect(A, null, D, p, x, null);
  }
  function E(R, A, D, S) {
    let M = null;
    const C =
      D.isPointLight === !0 ? R.customDistanceMaterial : R.customDepthMaterial;
    if (C !== void 0) M = C;
    else if (
      ((M = D.isPointLight === !0 ? c : o),
      ...
      let K = X[z];
      K === void 0 &&
        ((K = M.clone()), (X[z] = K), A.addEventListener("dispose", L)),
        (M = K);
    }
    if (
      ((M.visible = A.visible),
      ...
      const H = s.properties.get(M);
      H.light = D;
    }
    return M;
  }
  function y(R, A, D, S, M) {
    if (R.visible === !1) return;
    if (
      R.layers.test(A.layers) &&
      (R.isMesh || R.isLine || R.isPoints) &&
      (R.castShadow || (R.receiveShadow && M === Mn)) &&
      ...
      if (Array.isArray(X)) {
        ...
        for (let G = 0, Z = K.length; G < Z; G++) {
          const k = K[G],
            oe = X[k.materialIndex];
          if (oe && oe.visible) {
            const he = E(R, oe, S, M);
            R.onBeforeShadow(s, R, A, D, z, he, k),
              s.renderBufferDirect(D, null, z, he, R, k),
              R.onAfterShadow(s, R, A, D, z, he, k);
          }
        }
      } else if (X.visible) {
        const K = E(R, X, S, M);
        R.onBeforeShadow(s, R, A, D, z, K, null),
          s.renderBufferDirect(D, null, z, K, R, null),
          R.onAfterShadow(s, R, A, D, z, K, null);
      }
    }
    const H = R.children;
    for (let z = 0, X = H.length; z < X; z++) y(H[z], A, D, S, M);
  }
  function L(R) {
...
function Bg(s, e) {
  function t() {
    ...
    const re = new Ke();
    let J = null;
    const de = new Ke(0, 0, 0, 0);
    return {
      setMask: function (Q) {
        J !== Q && !P && (s.colorMask(Q, Q, Q, Q), (J = Q));
      },
      setLocked: function (Q) {
        P = Q;
      },
      setClear: function (Q, Y, fe, Ie, st) {
        st === !0 && ((Q *= Ie), (Y *= Ie), (fe *= Ie)),
          re.set(Q, Y, fe, Ie),
          de.equals(re) === !1 && (s.clearColor(Q, Y, fe, Ie), de.copy(re));
      },
      reset: function () {
        (P = !1), (J = null), de.set(-1, 0, 0, 0);
      },
    };
  }
  function n() {
    ...
    return {
      ...
      setTest: function (Y) {
        Y ? ce(s.DEPTH_TEST) : Me(s.DEPTH_TEST);
      },
      setMask: function (Y) {
        J !== Y && !P && (s.depthMask(Y), (J = Y));
      },
      setFunc: function (Y) {
        if ((re && (Y = Og[Y]), de !== Y)) {
          switch (Y) {
      ...
      setClear: function (Y) {
        Q !== Y && (re && (Y = 1 - Y), s.clearDepth(Y), (Q = Y));
      },
      reset: function () {
        (P = !1), (J = null), (de = null), (Q = null), (re = !1);
      },
    };
  }
  function i() {
    ...
    return {
      setTest: function (je) {
        P || (je ? ce(s.STENCIL_TEST) : Me(s.STENCIL_TEST));
      },
      setMask: function (je) {
        re !== je && !P && (s.stencilMask(je), (re = je));
      },
      setFunc: function (je, jt, fn) {
        (J !== je || de !== jt || Q !== fn) &&
          (s.stencilFunc(je, jt, fn), (J = je), (de = jt), (Q = fn));
      },
      setOp: function (je, jt, fn) {
        (Y !== je || fe !== jt || Ie !== fn) &&
          (s.stencilOp(je, jt, fn), (Y = je), (fe = jt), (Ie = fn));
      },
  ...
  k.indexOf("WebGL") !== -1
    ? ((Z = parseFloat(/^WebGL (\d)/.exec(k)[1])), (G = Z >= 1))
    : k.indexOf("OpenGL ES") !== -1 &&
      ((Z = parseFloat(/^OpenGL ES (\d)/.exec(k)[1])), (G = Z >= 2));
  let oe = null,
    he = {};
  const ye = s.getParameter(s.SCISSOR_BOX),
    Oe = s.getParameter(s.VIEWPORT),
    tt = new Ke().fromArray(ye),
    q = new Ke().fromArray(Oe);
  function te(P, re, J, de) {
    ...
    for (let fe = 0; fe < J; fe++)
      P === s.TEXTURE_3D || P === s.TEXTURE_2D_ARRAY
        ? s.texImage3D(re, 0, s.RGBA, 1, 1, de, 0, s.RGBA, s.UNSIGNED_BYTE, Q)
        : s.texImage2D(re + fe, 0, s.RGBA, 1, 1, 0, s.RGBA, s.UNSIGNED_BYTE, Q);
    return Y;
  }
  const ve = {};
  (ve[s.TEXTURE_2D] = te(s.TEXTURE_2D, s.TEXTURE_2D, 1)),
    (ve[s.TEXTURE_CUBE_MAP] = te(
      s.TEXTURE_CUBE_MAP,
      s.TEXTURE_CUBE_MAP_POSITIVE_X,
      6
    )),
    (ve[s.TEXTURE_2D_ARRAY] = te(s.TEXTURE_2D_ARRAY, s.TEXTURE_2D_ARRAY, 1, 1)),
    (ve[s.TEXTURE_3D] = te(s.TEXTURE_3D, s.TEXTURE_3D, 1, 1)),
    r.setClear(0, 0, 0, 1),
    a.setClear(1),
    o.setClear(0),
    ce(s.DEPTH_TEST),
  ...
  function Xe(P, re) {
    return h[P] !== re
      ? (s.bindFramebuffer(P, re),
        (h[P] = re),
        P === s.DRAW_FRAMEBUFFER && (h[s.FRAMEBUFFER] = re),
        P === s.FRAMEBUFFER && (h[s.DRAW_FRAMEBUFFER] = re),
        !0)
      : !1;
  }
  function we(P, re) {
    ...
    if (P) {
      ...
      const Q = P.textures;
      if (J.length !== Q.length || J[0] !== s.COLOR_ATTACHMENT0) {
        for (let Y = 0, fe = Q.length; Y < fe; Y++)
          J[Y] = s.COLOR_ATTACHMENT0 + Y;
        (J.length = Q.length), (de = !0);
      }
    } else J[0] !== s.BACK && ((J[0] = s.BACK), (de = !0));
    de && s.drawBuffers(J);
  }
  function ot(P) {
    return g !== P ? (s.useProgram(P), (g = P), !0) : !1;
  }
  const ct = {
    [ti]: s.FUNC_ADD,
    [Gl]: s.FUNC_SUBTRACT,
  ...
  (ct[Xl] = s.MIN), (ct[ql] = s.MAX);
  const qe = {
    [Yl]: s.ZERO,
    [Kl]: s.ONE,
    [jl]: s.SRC_COLOR,
    [Kr]: s.SRC_ALPHA,
    [tu]: s.SRC_ALPHA_SATURATE,
    [Ql]: s.DST_COLOR,
    [Zl]: s.DST_ALPHA,
    [$l]: s.ONE_MINUS_SRC_COLOR,
    [jr]: s.ONE_MINUS_SRC_ALPHA,
    [eu]: s.ONE_MINUS_DST_COLOR,
    [Jl]: s.ONE_MINUS_DST_ALPHA,
    [nu]: s.CONSTANT_COLOR,
    [iu]: s.ONE_MINUS_CONSTANT_COLOR,
    [su]: s.CONSTANT_ALPHA,
    [ru]: s.ONE_MINUS_CONSTANT_ALPHA,
  };
  function w(P, re, J, de, Q, Y, fe, Ie, st, je) {
    if (P === Bn) {
      x === !0 && (Me(s.BLEND), (x = !1));
      return;
    }
    if ((x === !1 && (ce(s.BLEND), (x = !0)), P !== Vl)) {
      if (P !== m || je !== S) {
        if (
          ((f !== ti || y !== ti) &&
            (s.blendEquation(s.FUNC_ADD), (f = ti), (y = ti)),
          je)
        )
          switch (P) {
            case Ei:
    ...
    (Q = Q || re),
      ...
      (fe = fe || de),
      (re !== f || Q !== y) &&
        (s.blendEquationSeparate(ct[re], ct[Q]), (f = re), (y = Q)),
      (J !== b || de !== E || Y !== L || fe !== R) &&
        (s.blendFuncSeparate(qe[J], qe[de], qe[Y], qe[fe]),
        (b = J),
        (E = de),
        (L = Y),
        (R = fe)),
      (Ie.equals(A) === !1 || st !== D) &&
        (s.blendColor(Ie.r, Ie.g, Ie.b, st), A.copy(Ie), (D = st)),
      (m = P),
      (S = !1);
  }
  function Tt(P, re) {
    P.side === Qt ? Me(s.CULL_FACE) : ce(s.CULL_FACE);
    let J = P.side === Nt;
    re && (J = !J),
      Ye(J),
      P.blending === Ei && P.transparent === !1
        ? w(Bn)
        : w(
            P.blending,
            P.blendEquation,
    ...
    o.setTest(de),
      ...
      Ge(P.polygonOffset, P.polygonOffsetFactor, P.polygonOffsetUnits),
      P.alphaToCoverage === !0
        ? ce(s.SAMPLE_ALPHA_TO_COVERAGE)
  ...
  function ge(P) {
    P !== H && (G && s.lineWidth(P), (H = P));
  }
  function Ge(P, re, J) {
    P
      ? (ce(s.POLYGON_OFFSET_FILL),
        (z !== re || X !== J) && (s.polygonOffset(re, J), (z = re), (X = J)))
      : Me(s.POLYGON_OFFSET_FILL);
  }
  function Ee(P) {
    P ? ce(s.SCISSOR_TEST) : Me(s.SCISSOR_TEST);
  }
  function Ne(P) {
    P === void 0 && (P = s.TEXTURE0 + K - 1),
      oe !== P && (s.activeTexture(P), (oe = P));
  }
  function ft(P, re, J) {
    J === void 0 && (oe === null ? (J = s.TEXTURE0 + K - 1) : (J = oe));
    let de = he[J];
    de === void 0 && ((de = { type: void 0, texture: void 0 }), (he[J] = de)),
      (de.type !== P || de.texture !== re) &&
        (oe !== J && (s.activeTexture(J), (oe = J)),
        s.bindTexture(P, re || ve[P]),
        (de.type = P),
        (de.texture = re));
  }
  function T() {
  ...
  function le(P) {
    tt.equals(P) === !1 && (s.scissor(P.x, P.y, P.z, P.w), tt.copy(P));
  }
  function Ae(P) {
    q.equals(P) === !1 && (s.viewport(P.x, P.y, P.z, P.w), q.copy(P));
  }
  function be(P, re) {
    let J = l.get(re);
    J === void 0 && ((J = new WeakMap()), l.set(re, J));
    let de = J.get(P);
    de === void 0 && ((de = s.getUniformBlockIndex(re, P.name)), J.set(P, de));
  }
  function ne(P, re) {
    const de = l.get(re).get(P);
    c.get(re) !== de &&
      (s.uniformBlockBinding(re, de, P.__bindingPointIndex), c.set(re, de));
  }
  function Pe() {
    s.disable(s.BLEND),
      ...
      (z = null),
      (X = null),
      tt.set(0, 0, s.canvas.width, s.canvas.height),
...
function zg(s, e, t, n, i, r, a) {
  ...
  function g(T, _) {
    return p ? new OffscreenCanvas(T, _) : us("canvas");
  }
  function x(T, _, F) {
    let W = 1;
    const j = ft(T);
    if (
      ((j.width > F || j.height > F) && (W = F / Math.max(j.width, j.height)),
      W < 1)
    )
      if (
        ...
        const V = Math.floor(W * j.width),
          _e = Math.floor(W * j.height);
        h === void 0 && (h = g(V, _e));
        const se = _ ? g(V, _e) : h;
        return (
          (se.width = V),
          (se.height = _e),
          se.getContext("2d").drawImage(T, 0, 0, V, _e),
          console.warn(
  ...
  function E(T, _, F, W, j = !1) {
    ...
    if (
      (_ === s.RED &&
        (F === s.FLOAT && (V = s.R32F),
        F === s.HALF_FLOAT && (V = s.R16F),
        F === s.UNSIGNED_BYTE && (V = s.R8)),
      _ === s.RED_INTEGER &&
        (F === s.UNSIGNED_BYTE && (V = s.R8UI),
        F === s.UNSIGNED_SHORT && (V = s.R16UI),
        F === s.UNSIGNED_INT && (V = s.R32UI),
        F === s.BYTE && (V = s.R8I),
        F === s.SHORT && (V = s.R16I),
        F === s.INT && (V = s.R32I)),
      _ === s.RG &&
        (F === s.FLOAT && (V = s.RG32F),
        F === s.HALF_FLOAT && (V = s.RG16F),
        F === s.UNSIGNED_BYTE && (V = s.RG8)),
      _ === s.RG_INTEGER &&
        (F === s.UNSIGNED_BYTE && (V = s.RG8UI),
        F === s.UNSIGNED_SHORT && (V = s.RG16UI),
        F === s.UNSIGNED_INT && (V = s.RG32UI),
        F === s.BYTE && (V = s.RG8I),
        F === s.SHORT && (V = s.RG16I),
        F === s.INT && (V = s.RG32I)),
      _ === s.RGB_INTEGER &&
        (F === s.UNSIGNED_BYTE && (V = s.RGB8UI),
        F === s.UNSIGNED_SHORT && (V = s.RGB16UI),
        F === s.UNSIGNED_INT && (V = s.RGB32UI),
        F === s.BYTE && (V = s.RGB8I),
        F === s.SHORT && (V = s.RGB16I),
        F === s.INT && (V = s.RGB32I)),
      _ === s.RGBA_INTEGER &&
        (F === s.UNSIGNED_BYTE && (V = s.RGBA8UI),
        F === s.UNSIGNED_SHORT && (V = s.RGBA16UI),
        F === s.UNSIGNED_INT && (V = s.RGBA32UI),
        F === s.BYTE && (V = s.RGBA8I),
        F === s.SHORT && (V = s.RGBA16I),
        F === s.INT && (V = s.RGBA32I)),
      _ === s.RGB && F === s.UNSIGNED_INT_5_9_9_9_REV && (V = s.RGB9_E5),
      _ === s.RGBA)
    ) {
      const _e = j ? Qs : Ve.getTransfer(W);
      F === s.FLOAT && (V = s.RGBA32F),
        F === s.HALF_FLOAT && (V = s.RGBA16F),
        F === s.UNSIGNED_BYTE && (V = _e === Qe ? s.SRGB8_ALPHA8 : s.RGBA8),
        F === s.UNSIGNED_SHORT_4_4_4_4 && (V = s.RGBA4),
        F === s.UNSIGNED_SHORT_5_5_5_1 && (V = s.RGB5_A1);
    }
    return (
      (V === s.R16F ||
        V === s.R32F ||
  ...
  function y(T, _) {
    ...
    return (
      T
        ? _ === null || _ === ii || _ === rs
          ? (F = s.DEPTH24_STENCIL8)
          : _ === nn
          ? (F = s.DEPTH32F_STENCIL8)
          : _ === ss &&
            ((F = s.DEPTH24_STENCIL8),
            console.warn(
        ...
        : _ === null || _ === ii || _ === rs
        ? (F = s.DEPTH_COMPONENT24)
        : _ === nn
        ? (F = s.DEPTH_COMPONENT32F)
        : _ === ss && (F = s.DEPTH_COMPONENT16),
      F
    );
  }
  function L(T, _) {
    return m(T) === !0 ||
      (T.isFramebufferTexture && T.minFilter !== Pt && T.minFilter !== Ht)
  ...
  function R(T) {
    const _ = T.target;
    _.removeEventListener("dispose", R), D(_), _.isVideoTexture && u.delete(_);
  }
  function A(T) {
    const _ = T.target;
  ...
  function D(T) {
    ...
    if (W) {
      ...
      j.usedTimes--,
        j.usedTimes === 0 && S(T),
        Object.keys(W).length === 0 && d.delete(F);
    }
    n.remove(T);
  }
  function S(T) {
  ...
  function M(T) {
    ...
    if (
      ...
      for (let W = 0; W < 6; W++) {
        if (Array.isArray(_.__webglFramebuffer[W]))
          for (let j = 0; j < _.__webglFramebuffer[W].length; j++)
            s.deleteFramebuffer(_.__webglFramebuffer[W][j]);
      ...
      if (Array.isArray(_.__webglFramebuffer))
        for (let W = 0; W < _.__webglFramebuffer.length; W++)
          s.deleteFramebuffer(_.__webglFramebuffer[W]);
      ...
      if (
        ...
        for (let W = 0; W < _.__webglColorRenderbuffer.length; W++)
          _.__webglColorRenderbuffer[W] &&
            s.deleteRenderbuffer(_.__webglColorRenderbuffer[W]);
    ...
    for (let W = 0, j = F.length; W < j; W++) {
      const V = n.get(F[W]);
      V.__webglTexture &&
        (s.deleteTexture(V.__webglTexture), a.memory.textures--),
        n.remove(F[W]);
    }
    n.remove(T);
  }
  ...
  function K(T, _) {
    ...
    t.bindTexture(s.TEXTURE_2D, F.__webglTexture, s.TEXTURE0 + _);
  }
  function G(T, _) {
    const F = n.get(T);
    ...
    t.bindTexture(s.TEXTURE_2D_ARRAY, F.__webglTexture, s.TEXTURE0 + _);
  }
  function Z(T, _) {
    const F = n.get(T);
    if (T.version > 0 && F.__version !== T.version) {
    ...
    t.bindTexture(s.TEXTURE_3D, F.__webglTexture, s.TEXTURE0 + _);
  }
  function k(T, _) {
    const F = n.get(T);
    if (T.version > 0 && F.__version !== T.version) {
    ...
    t.bindTexture(s.TEXTURE_CUBE_MAP, F.__webglTexture, s.TEXTURE0 + _);
  }
  const oe = { [Li]: s.REPEAT, [Fn]: s.CLAMP_TO_EDGE, [Js]: s.MIRRORED_REPEAT },
    he = {
      [Pt]: s.NEAREST,
      [qc]: s.NEAREST_MIPMAP_NEAREST,
      [Qi]: s.NEAREST_MIPMAP_LINEAR,
      [Ht]: s.LINEAR,
      [Ws]: s.LINEAR_MIPMAP_NEAREST,
      [Sn]: s.LINEAR_MIPMAP_LINEAR,
    },
    ye = {
      [Mu]: s.NEVER,
      [Au]: s.ALWAYS,
  ...
  function Oe(T, _) {
    if (
      ...
      s.texParameteri(T, s.TEXTURE_MAG_FILTER, he[_.magFilter]),
      s.texParameteri(T, s.TEXTURE_MIN_FILTER, he[_.minFilter]),
      _.compareFunction &&
        (s.texParameteri(T, s.TEXTURE_COMPARE_MODE, s.COMPARE_REF_TO_TEXTURE),
        s.texParameteri(T, s.TEXTURE_COMPARE_FUNC, ye[_.compareFunction])),
      e.has("EXT_texture_filter_anisotropic") === !0)
    ) {
      if (
        _.magFilter === Pt ||
        (_.minFilter !== Qi && _.minFilter !== Sn) ||
        (_.type === nn && e.has("OES_texture_float_linear") === !1)
      )
        return;
  ...
  function tt(T, _) {
    ...
    T.__webglInit === void 0 &&
      ((T.__webglInit = !0), _.addEventListener("dispose", R));
    const W = _.source;
    let j = d.get(W);
    j === void 0 && ((j = {}), d.set(W, j));
    const V = X(_);
    if (V !== T.__cacheKey) {
      j[V] === void 0 &&
        ((j[V] = { texture: s.createTexture(), usedTimes: 0 }),
        a.memory.textures++,
        (F = !0)),
        j[V].usedTimes++;
      const _e = j[T.__cacheKey];
      _e !== void 0 &&
        (j[T.__cacheKey].usedTimes--, _e.usedTimes === 0 && S(_)),
        (T.__cacheKey = V),
        (T.__webglTexture = j[V].texture);
    }
    return F;
  }
  function q(T, _, F) {
  ...
  function te(T, _, F, W) {
    ...
    if (V.length === 0)
      t.texSubImage2D(s.TEXTURE_2D, 0, 0, 0, _.width, _.height, F, W, _.data);
    else {
      V.sort(($, le) => $.start - le.start);
      let _e = 0;
      for (let $ = 1; $ < V.length; $++) {
        const le = V[_e],
          Ae = V[$],
          be = le.start + le.count,
          ne = q(Ae.start, _.width, 4),
          Pe = q(le.start, _.width, 4);
        Ae.start <= be + 1 &&
        ne === Pe &&
        q(Ae.start + Ae.count - 1, _.width, 4) === ne
          ? (le.count = Math.max(le.count, Ae.start + Ae.count - le.start))
          : (++_e, (V[_e] = Ae));
      }
      V.length = _e + 1;
      const se = s.getParameter(s.UNPACK_ROW_LENGTH),
        me = s.getParameter(s.UNPACK_SKIP_PIXELS),
        xe = s.getParameter(s.UNPACK_SKIP_ROWS);
      s.pixelStorei(s.UNPACK_ROW_LENGTH, _.width);
      for (let $ = 0, le = V.length; $ < le; $++) {
        const Ae = V[$],
          ...
          re = ne,
          J = 1;
        s.pixelStorei(s.UNPACK_SKIP_PIXELS, Pe),
          s.pixelStorei(s.UNPACK_SKIP_ROWS, P),
          t.texSubImage2D(s.TEXTURE_2D, 0, Pe, P, re, J, F, W, _.data);
      }
      T.clearUpdateRanges(),
        s.pixelStorei(s.UNPACK_ROW_LENGTH, se),
        s.pixelStorei(s.UNPACK_SKIP_PIXELS, me),
        s.pixelStorei(s.UNPACK_SKIP_ROWS, xe);
    }
  }
  function ve(T, _, F) {
    let W = s.TEXTURE_2D;
    (_.isDataArrayTexture || _.isCompressedArrayTexture) &&
      (W = s.TEXTURE_2D_ARRAY),
      _.isData3DTexture && (W = s.TEXTURE_3D);
    const j = tt(T, _),
      V = _.source;
    t.bindTexture(W, T.__webglTexture, s.TEXTURE0 + F);
    const _e = n.get(V);
    if (V.version !== _e.__version || j === !0) {
      t.activeTexture(s.TEXTURE0 + F);
      const se = Ve.getPrimaries(Ve.workingColorSpace),
        me = _.colorSpace === Nn ? null : Ve.getPrimaries(_.colorSpace),
        xe =
          _.colorSpace === Nn || se === me ? s.NONE : s.BROWSER_DEFAULT_WEBGL;
      s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL, _.flipY),
        ...
        s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL, xe);
      let $ = x(_.image, !1, i.maxTextureSize);
      $ = Ne(_, $);
      const le = r.convert(_.format, _.colorSpace),
        Ae = r.convert(_.type);
      let be = E(_.internalFormat, le, Ae, _.colorSpace, _.isVideoTexture);
      Oe(W, _);
      let ne;
      const Pe = _.mipmaps,
        P = _.isVideoTexture !== !0,
        re = _e.__version === void 0 || j === !0,
        J = V.dataReady,
        de = L(_, $);
      if (_.isDepthTexture)
        (be = y(_.format === os, _.type)),
          re &&
            (P
              ? t.texStorage2D(s.TEXTURE_2D, 1, be, $.width, $.height)
              : t.texImage2D(
                  s.TEXTURE_2D,
                  0,
                  be,
        ...
        if (Pe.length > 0) {
          P &&
            re &&
            t.texStorage2D(s.TEXTURE_2D, de, be, Pe[0].width, Pe[0].height);
          for (let Q = 0, Y = Pe.length; Q < Y; Q++)
            (ne = Pe[Q]),
              P
                ? J &&
                  t.texSubImage2D(
          ...
          P
            ? (re && t.texStorage2D(s.TEXTURE_2D, de, be, $.width, $.height),
              J && te(_, $, le, Ae))
            : t.texImage2D(
                s.TEXTURE_2D,
                0,
        ...
        if (_.isCompressedArrayTexture) {
          ...
          for (let Q = 0, Y = Pe.length; Q < Y; Q++)
            if (((ne = Pe[Q]), _.format !== qt))
              if (le !== null)
                if (P) {
                  if (J)
                    if (_.layerUpdates.size > 0) {
                      const fe = cc(ne.width, ne.height, _.format, _.type);
                      for (const Ie of _.layerUpdates) {
                        const st = ne.data.subarray(
                          (Ie * fe) / ne.data.BYTES_PER_ELEMENT,
        ...
        if (P) {
          if (
            ...
            if (_.layerUpdates.size > 0) {
              const Q = cc($.width, $.height, _.format, _.type);
              for (const Y of _.layerUpdates) {
                const fe = $.data.subarray(
                  (Y * Q) / $.data.BYTES_PER_ELEMENT,
        ...
        P
          ? (re &&
              t.texStorage3D(s.TEXTURE_3D, de, be, $.width, $.height, $.depth),
            J &&
              t.texSubImage3D(
                s.TEXTURE_3D,
                0,
        ...
        if (re)
          if (P) t.texStorage2D(s.TEXTURE_2D, de, be, $.width, $.height);
          else {
            let Q = $.width,
              Y = $.height;
            for (let fe = 0; fe < de; fe++)
              t.texImage2D(s.TEXTURE_2D, fe, be, Q, Y, 0, le, Ae, null),
                (Q >>= 1),
                (Y >>= 1);
          }
      } else if (Pe.length > 0) {
        if (P && re) {
          const Q = ft(Pe[0]);
          t.texStorage2D(s.TEXTURE_2D, de, be, Q.width, Q.height);
        }
        for (let Q = 0, Y = Pe.length; Q < Y; Q++)
          (ne = Pe[Q]),
            P
              ? J && t.texSubImage2D(s.TEXTURE_2D, Q, 0, 0, le, Ae, ne)
              : t.texImage2D(s.TEXTURE_2D, Q, be, le, Ae, ne);
        _.generateMipmaps = !1;
      } else if (P) {
        if (re) {
          const Q = ft($);
        ...
        J && t.texSubImage2D(s.TEXTURE_2D, 0, 0, 0, le, Ae, $);
      } else t.texImage2D(s.TEXTURE_2D, 0, be, le, Ae, $);
      m(_) && f(W), (_e.__version = V.version), _.onUpdate && _.onUpdate(_);
    }
  ...
  function ce(T, _, F) {
    ...
    if (j.version !== V.__version || W === !0) {
      ...
      const _e = Ve.getPrimaries(Ve.workingColorSpace),
        se = _.colorSpace === Nn ? null : Ve.getPrimaries(_.colorSpace),
        me =
          _.colorSpace === Nn || _e === se ? s.NONE : s.BROWSER_DEFAULT_WEBGL;
      s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL, _.flipY),
        s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL, _.premultiplyAlpha),
        s.pixelStorei(s.UNPACK_ALIGNMENT, _.unpackAlignment),
        s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL, me);
      const xe = _.isCompressedTexture || _.image[0].isCompressedTexture,
        $ = _.image[0] && _.image[0].isDataTexture,
        le = [];
      for (let Y = 0; Y < 6; Y++)
        !xe && !$
          ? (le[Y] = x(_.image[Y], !0, i.maxCubemapSize))
          : (le[Y] = $ ? _.image[Y].image : _.image[Y]),
          (le[Y] = Ne(_, le[Y]));
      const Ae = le[0],
        be = r.convert(_.format, _.colorSpace),
        ne = r.convert(_.type),
        Pe = E(_.internalFormat, be, ne, _.colorSpace),
        P = _.isVideoTexture !== !0,
        re = V.__version === void 0 || W === !0,
        J = j.dataReady;
      let de = L(_, Ae);
      Oe(s.TEXTURE_CUBE_MAP, _);
      let Q;
      if (xe) {
        P &&
          re &&
          t.texStorage2D(s.TEXTURE_CUBE_MAP, de, Pe, Ae.width, Ae.height);
        for (let Y = 0; Y < 6; Y++) {
          Q = le[Y].mipmaps;
            ...
            _.format !== qt
              ? be !== null
                ? P
                  ? J &&
                    t.compressedTexSubImage2D(
                      s.TEXTURE_CUBE_MAP_POSITIVE_X + Y,
                      fe,
                      0,
                      0,
                      Ie.width,
        ...
        if (((Q = _.mipmaps), P && re)) {
          Q.length > 0 && de++;
          const Y = ft(le[0]);
          t.texStorage2D(s.TEXTURE_CUBE_MAP, de, Pe, Y.width, Y.height);
        }
        for (let Y = 0; Y < 6; Y++)
          if ($) {
            P
      ...
      m(_) && f(s.TEXTURE_CUBE_MAP),
        (V.__version = j.version),
        _.onUpdate && _.onUpdate(_);
    }
    T.__version = _.version;
  }
  function Me(T, _, F, W, j, V) {
    const _e = r.convert(F.format, F.colorSpace),
      se = r.convert(F.type),
      me = E(F.internalFormat, _e, se, F.colorSpace),
      xe = n.get(_),
      $ = n.get(F);
    if ((($.__renderTarget = _), !xe.__hasExternalTextures)) {
      const le = Math.max(1, _.width >> V),
        Ae = Math.max(1, _.height >> V);
      j === s.TEXTURE_3D || j === s.TEXTURE_2D_ARRAY
        ? t.texImage3D(j, V, me, le, Ae, _.depth, 0, _e, se, null)
        : t.texImage2D(j, V, me, le, Ae, 0, _e, se, null);
    }
    t.bindFramebuffer(s.FRAMEBUFFER, T),
      Ge(_)
        ...
        : (j === s.TEXTURE_2D ||
          ...
          s.framebufferTexture2D(s.FRAMEBUFFER, W, j, $.__webglTexture, V),
      t.bindFramebuffer(s.FRAMEBUFFER, null);
  }
  function Xe(T, _, F) {
    if ((s.bindRenderbuffer(s.RENDERBUFFER, T), _.depthBuffer)) {
      const W = _.depthTexture,
        j = W && W.isDepthTexture ? W.type : null,
        V = y(_.stencilBuffer, j),
        _e = _.stencilBuffer ? s.DEPTH_STENCIL_ATTACHMENT : s.DEPTH_ATTACHMENT,
        se = ge(_);
      Ge(_)
        ...
        : s.renderbufferStorage(s.RENDERBUFFER, V, _.width, _.height),
        s.framebufferRenderbuffer(s.FRAMEBUFFER, _e, s.RENDERBUFFER, T);
    } else {
      const W = _.textures;
      for (let j = 0; j < W.length; j++) {
        const V = W[j],
          ...
          se = r.convert(V.type),
          me = E(V.internalFormat, _e, se, V.colorSpace),
          xe = ge(_);
        F && Ge(_) === !1
          ? s.renderbufferStorageMultisample(
              s.RENDERBUFFER,
          ...
          : s.renderbufferStorage(s.RENDERBUFFER, me, _.width, _.height);
      }
    }
  ...
  function we(T, _) {
    ...
    (W.__renderTarget = _),
      ...
      K(_.depthTexture, 0);
    const j = W.__webglTexture,
      V = ge(_);
    if (_.depthTexture.format === as)
      Ge(_)
        ? o.framebufferTexture2DMultisampleEXT(
            s.FRAMEBUFFER,
            s.DEPTH_ATTACHMENT,
    ...
    else if (_.depthTexture.format === os)
      Ge(_)
        ? o.framebufferTexture2DMultisampleEXT(
            s.FRAMEBUFFER,
  ...
  function ot(T) {
      ...
      if ((_.__depthDisposeCallback && _.__depthDisposeCallback(), W)) {
        const j = () => {
          delete _.__boundDepthTexture,
            ...
            W.removeEventListener("dispose", j);
        };
    ...
    if (T.depthTexture && !_.__autoAllocateDepthBuffer) {
      ...
      W && W.length > 0
        ? we(_.__webglFramebuffer[0], T)
        : we(_.__webglFramebuffer, T);
    } else if (F) {
      _.__webglDepthbuffer = [];
      for (let W = 0; W < 6; W++)
        if (
          (t.bindFramebuffer(s.FRAMEBUFFER, _.__webglFramebuffer[W]),
          _.__webglDepthbuffer[W] === void 0)
        )
          (_.__webglDepthbuffer[W] = s.createRenderbuffer()),
            Xe(_.__webglDepthbuffer[W], T, !1);
        else {
          const j = T.stencilBuffer
              ? s.DEPTH_STENCIL_ATTACHMENT
              : s.DEPTH_ATTACHMENT,
            V = _.__webglDepthbuffer[W];
          s.bindRenderbuffer(s.RENDERBUFFER, V),
            s.framebufferRenderbuffer(s.FRAMEBUFFER, j, s.RENDERBUFFER, V);
        }
    } else {
      const W = T.texture.mipmaps;
      if (
        (W && W.length > 0
          ? t.bindFramebuffer(s.FRAMEBUFFER, _.__webglFramebuffer[0])
          : t.bindFramebuffer(s.FRAMEBUFFER, _.__webglFramebuffer),
        _.__webglDepthbuffer === void 0)
      )
        (_.__webglDepthbuffer = s.createRenderbuffer()),
          Xe(_.__webglDepthbuffer, T, !1);
      else {
        const j = T.stencilBuffer
            ? s.DEPTH_STENCIL_ATTACHMENT
            : s.DEPTH_ATTACHMENT,
  ...
  function qe(T) {
    ...
    if (
      (_e ||
        (W.__webglTexture === void 0 && (W.__webglTexture = s.createTexture()),
      ...
      for (let se = 0; se < 6; se++)
        if (_.mipmaps && _.mipmaps.length > 0) {
          ...
          for (let me = 0; me < _.mipmaps.length; me++)
            F.__webglFramebuffer[se][me] = s.createFramebuffer();
        } else F.__webglFramebuffer[se] = s.createFramebuffer();
    } else {
      if (_.mipmaps && _.mipmaps.length > 0) {
        F.__webglFramebuffer = [];
        for (let se = 0; se < _.mipmaps.length; se++)
          F.__webglFramebuffer[se] = s.createFramebuffer();
      } else F.__webglFramebuffer = s.createFramebuffer();
      if (_e)
        for (let se = 0, me = j.length; se < me; se++) {
          const xe = n.get(j[se]);
          xe.__webglTexture === void 0 &&
            ((xe.__webglTexture = s.createTexture()), a.memory.textures++);
        }
      if (T.samples > 0 && Ge(T) === !1) {
        (F.__webglMultisampledFramebuffer = s.createFramebuffer()),
          (F.__webglColorRenderbuffer = []),
          t.bindFramebuffer(s.FRAMEBUFFER, F.__webglMultisampledFramebuffer);
        for (let se = 0; se < j.length; se++) {
          const me = j[se];
          (F.__webglColorRenderbuffer[se] = s.createRenderbuffer()),
            s.bindRenderbuffer(s.RENDERBUFFER, F.__webglColorRenderbuffer[se]);
          const xe = r.convert(me.format, me.colorSpace),
            $ = r.convert(me.type),
            le = E(
              me.internalFormat,
              xe,
        ...
        s.bindRenderbuffer(s.RENDERBUFFER, null),
          T.depthBuffer &&
            ((F.__webglDepthRenderbuffer = s.createRenderbuffer()),
            Xe(F.__webglDepthRenderbuffer, T, !0)),
          t.bindFramebuffer(s.FRAMEBUFFER, null);
      }
    }
    if (V) {
      t.bindTexture(s.TEXTURE_CUBE_MAP, W.__webglTexture),
        Oe(s.TEXTURE_CUBE_MAP, _);
      for (let se = 0; se < 6; se++)
        if (_.mipmaps && _.mipmaps.length > 0)
          for (let me = 0; me < _.mipmaps.length; me++)
            Me(
              F.__webglFramebuffer[se][me],
              T,
              _,
              s.COLOR_ATTACHMENT0,
              s.TEXTURE_CUBE_MAP_POSITIVE_X + se,
              me
            );
        else
          Me(
      ...
      m(_) && f(s.TEXTURE_CUBE_MAP), t.unbindTexture();
    } else if (_e) {
      for (let se = 0, me = j.length; se < me; se++) {
        const xe = j[se],
          $ = n.get(xe);
        t.bindTexture(s.TEXTURE_2D, $.__webglTexture),
          Oe(s.TEXTURE_2D, xe),
          Me(
            F.__webglFramebuffer,
            T,
      ...
      if (
        ((T.isWebGL3DRenderTarget || T.isWebGLArrayRenderTarget) &&
          (se = T.isWebGL3DRenderTarget ? s.TEXTURE_3D : s.TEXTURE_2D_ARRAY),
        t.bindTexture(se, W.__webglTexture),
        Oe(se, _),
        _.mipmaps && _.mipmaps.length > 0)
      )
        for (let me = 0; me < _.mipmaps.length; me++)
          Me(F.__webglFramebuffer[me], T, _, s.COLOR_ATTACHMENT0, se, me);
      else Me(F.__webglFramebuffer, T, _, s.COLOR_ATTACHMENT0, se, 0);
  ...
  function w(T) {
    ...
    for (let F = 0, W = _.length; F < W; F++) {
      ...
      if (m(j)) {
        const V = b(T),
          _e = n.get(j).__webglTexture;
        t.bindTexture(V, _e), f(V), t.unbindTexture();
      }
    }
  }
  const Tt = [],
      ...
      if (Ge(T) === !1) {
        ...
        if (se)
          for (let xe = 0; xe < _.length; xe++)
            t.bindFramebuffer(s.FRAMEBUFFER, _e.__webglMultisampledFramebuffer),
              s.framebufferRenderbuffer(
                s.FRAMEBUFFER,
                s.COLOR_ATTACHMENT0 + xe,
                s.RENDERBUFFER,
                null
              ),
              t.bindFramebuffer(s.FRAMEBUFFER, _e.__webglFramebuffer),
              s.framebufferTexture2D(
                s.DRAW_FRAMEBUFFER,
                s.COLOR_ATTACHMENT0 + xe,
                s.TEXTURE_2D,
        ...
        me && me.length > 0
          ? t.bindFramebuffer(s.DRAW_FRAMEBUFFER, _e.__webglFramebuffer[0])
          : t.bindFramebuffer(s.DRAW_FRAMEBUFFER, _e.__webglFramebuffer);
        for (let xe = 0; xe < _.length; xe++) {
          if (
            (T.resolveDepthBuffer &&
              (T.depthBuffer && (j |= s.DEPTH_BUFFER_BIT),
              T.stencilBuffer &&
            ...
            const $ = n.get(_[xe]).__webglTexture;
            s.framebufferTexture2D(
              s.DRAW_FRAMEBUFFER,
              s.COLOR_ATTACHMENT0,
              s.TEXTURE_2D,
          ...
          s.blitFramebuffer(0, 0, F, W, 0, 0, F, W, j, s.NEAREST),
            c === !0 &&
              ((Tt.length = 0),
              (Ye.length = 0),
              Tt.push(s.COLOR_ATTACHMENT0 + xe),
              T.depthBuffer &&
                T.resolveDepthBuffer === !1 &&
                (Tt.push(V),
                Ye.push(V),
                s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER, Ye)),
              s.invalidateFramebuffer(s.READ_FRAMEBUFFER, Tt));
        }
        if (
...
function Hg(s, e) {
  function t(n, i = Nn) {
    ...
    if (n === ln) return s.UNSIGNED_BYTE;
    if (n === ka) return s.UNSIGNED_SHORT_4_4_4_4;
    if (n === Va) return s.UNSIGNED_SHORT_5_5_5_1;
    if (n === jc) return s.UNSIGNED_INT_5_9_9_9_REV;
    ...
    if (n === $c) return s.ALPHA;
    if (n === Zc) return s.RGB;
    if (n === qt) return s.RGBA;
    if (n === as) return s.DEPTH_COMPONENT;
    if (n === os) return s.DEPTH_STENCIL;
    if (n === Ga) return s.RED;
    if (n === Wa) return s.RED_INTEGER;
    if (n === Jc) return s.RG;
    if (n === Xa) return s.RG_INTEGER;
    if (n === qa) return s.RGBA_INTEGER;
    if (n === Xs || n === qs || n === Ys || n === Ks)
      if (a === Qe)
    ...
    return n === rs ? s.UNSIGNED_INT_24_8 : s[n] !== void 0 ? s[n] : null;
  }
  return { convert: t };
}
const kg = `
...
class Gg {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new Et(new fs(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(e, t) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getControllerGrip = function (q) {
        let te = E[q];
        return (
          te === void 0 && ((te = new Lr()), (E[q] = te)), te.getGripSpace()
        );
      }),
      (this.getHand = function (q) {
        let te = E[q];
        return (
          te === void 0 && ((te = new Lr()), (E[q] = te)), te.getHandSpace()
        );
      });
    function z(q) {
      const te = y.indexOf(q.inputSource);
      if (te === -1) return;
      const ve = E[te];
      ve !== void 0 &&
        (ve.update(q.inputSource, q.frame, l || a),
        ve.dispatchEvent({ type: q.type, data: q.inputSource }));
    }
    function X() {
      ...
      for (let q = 0; q < E.length; q++) {
        const te = y[q];
        te !== null && ((y[q] = null), E[q].disconnect(te));
      }
      (C = null),
        (H = null),
        x.reset(),
        ...
        if (((i = q), i !== null)) {
          if (
            ...
            (h = new XRWebGLBinding(i, t)),
              ...
              (b = new si(d.textureWidth, d.textureHeight, {
                format: qt,
                type: ln,
                depthTexture: new ml(
                  d.textureWidth,
    ...
    function K(q) {
      for (let te = 0; te < q.removed.length; te++) {
        const ve = q.removed[te],
          ce = y.indexOf(ve);
        ce >= 0 && ((y[ce] = null), E[ce].disconnect(ve));
      }
    ...
    function k(q, te, ve) {
      G.setFromMatrixPosition(te.matrixWorld),
        Z.setFromMatrixPosition(ve.matrixWorld);
      const ce = G.distanceTo(Z),
        Me = te.projectionMatrix.elements,
        Xe = ve.projectionMatrix.elements,
        we = Me[14] / (Me[10] - 1),
        ot = Me[14] / (Me[10] + 1),
        ct = (Me[9] + 1) / Me[5],
        qe = (Me[9] - 1) / Me[5],
      ...
      if (
        ...
        const Ee = we + ge,
          ...
          _ = ((ct * ot) / Ne) * Ee,
          F = ((qe * ot) / Ne) * Ee;
        q.projectionMatrix.makePerspective(ft, T, _, F, Ee, Ne),
    ...
    this.updateCamera = function (q) {
      ...
      let te = q.near,
        ve = q.far;
      x.texture !== null &&
        (x.depthNear > 0 && (te = x.depthNear),
        x.depthFar > 0 && (ve = x.depthFar)),
        (M.near = D.near = A.near = te),
        (M.far = D.far = A.far = ve),
        (C !== M.near || H !== M.far) &&
          (i.updateRenderState({ depthNear: M.near, depthFar: M.far }),
          (C = M.near),
          (H = M.far)),
        (A.layers.mask = q.layers.mask | 2),
        (D.layers.mask = q.layers.mask | 4),
        (M.layers.mask = A.layers.mask | D.layers.mask);
      const ce = q.parent,
        Me = M.cameras;
      oe(M, ce);
      for (let Xe = 0; Xe < Me.length; Xe++) oe(Me[Xe], ce);
      Me.length === 2
        ? k(M, A, D)
        : M.projectionMatrix.copy(A.projectionMatrix),
        he(q, M, ce);
    };
    function he(q, te, ve) {
      ve === null
        ? q.matrix.copy(te.matrixWorld)
        : (q.matrix.copy(ve.matrixWorld),
          q.matrix.invert(),
        ...
        q.isPerspectiveCamera &&
          ((q.fov = Ii * 2 * Math.atan(1 / q.projectionMatrix.elements[5])),
          (q.zoom = 1));
    }
    ...
    let ye = null;
    function Oe(q, te) {
      if (((u = te.getViewerPose(l || a)), (g = te), u !== null)) {
        const ve = u.views;
        p !== null &&
          (e.setRenderTargetFramebuffer(b, p.framebuffer),
          e.setRenderTarget(b));
        let ce = !1;
        ve.length !== M.cameras.length && ((M.cameras.length = 0), (ce = !0));
        for (let we = 0; we < ve.length; we++) {
          const ot = ve[we];
          let ct = null;
          if (p !== null) ct = p.getViewport(ot);
          else {
            const w = h.getViewSubImage(d, ot);
            (ct = w.viewport),
              we === 0 &&
          ...
          qe === void 0 &&
            ...
            (qe.viewport = new Ke()),
            (S[we] = qe)),
            qe.matrix.fromArray(ot.transform.matrix),
            qe.matrix.decompose(qe.position, qe.quaternion, qe.scale),
            qe.projectionMatrix.fromArray(ot.projectionMatrix),
            qe.projectionMatrixInverse.copy(qe.projectionMatrix).invert(),
            qe.viewport.set(ct.x, ct.y, ct.width, ct.height),
            we === 0 &&
              (M.matrix.copy(qe.matrix),
              M.matrix.decompose(M.position, M.quaternion, M.scale)),
            ce === !0 && M.cameras.push(qe);
        }
        const Me = i.enabledFeatures;
        if (
          Me &&
          Me.includes("depth-sensing") &&
          i.depthUsage == "gpu-optimized" &&
          h
        ) {
          const we = h.getDepthInformation(ve[0]);
          we && we.isValid && we.texture && x.init(e, we, i.renderState);
        }
      }
      for (let ve = 0; ve < E.length; ve++) {
        const ce = y[ve],
          Me = E[ve];
        ce !== null && Me !== void 0 && Me.update(ce, te, l || a);
      }
      ye && ye(q, te),
        te.detectedPlanes &&
...
function qg(s, e) {
  ...
  function n(m, f) {
    f.color.getRGB(m.fogColor.value, cl(s)),
      f.isFog
  ...
  function i(m, f, b, E, y) {
    f.isMeshBasicMaterial || f.isMeshLambertMaterial
      ...
      ? (r(m, f), d(m, f), f.isMeshPhysicalMaterial && p(m, f, y))
  ...
  function r(m, f) {
    ...
    E &&
      ...
      E.isCubeTexture &&
        ...
        ((Zn.y *= -1), (Zn.z *= -1)),
      m.envMapRotation.value.setFromMatrix4(Xg.makeRotationFromEuler(Zn)),
      (m.flipEnvMap.value =
...
function Yg(s, e, t, n) {
  ...
  function l(b, E) {
    let y = i[b.id];
    y === void 0 &&
      (g(b), (y = u(b)), (i[b.id] = y), b.addEventListener("dispose", m));
    const L = E.program;
  ...
  function u(b) {
    ...
    return (
      ...
      s.bufferData(s.UNIFORM_BUFFER, L, R),
      s.bindBuffer(s.UNIFORM_BUFFER, null),
      s.bindBufferBase(s.UNIFORM_BUFFER, E, y),
      y
    );
  }
  function h() {
  ...
  function d(b) {
    ...
    for (let R = 0, A = y.length; R < A; R++) {
      const D = Array.isArray(y[R]) ? y[R] : [y[R]];
        ...
        if (p(C, R, S, L) === !0) {
          ...
          for (let K = 0; K < z.length; K++) {
            ...
            typeof G == "number" || typeof G == "boolean"
              ? ((C.__data[0] = G),
                s.bufferSubData(s.UNIFORM_BUFFER, H + X, C.__data))
              : G.isMatrix3
              ? ((C.__data[0] = G.elements[0]),
                ...
                (C.__data[11] = 0))
              : (G.toArray(C.__data, X),
                (X += Z.storage / Float32Array.BYTES_PER_ELEMENT));
          }
          s.bufferSubData(s.UNIFORM_BUFFER, H, C.__data);
        }
      }
    }
    s.bindBuffer(s.UNIFORM_BUFFER, null);
  ...
  function p(b, E, y, L) {
      ...
      );
    {
      ...
      if (typeof R == "number" || typeof R == "boolean") {
        if (D !== R) return (L[A] = R), !0;
      } else if (D.equals(R) === !1) return D.copy(R), !0;
    }
    return !1;
  }
  function g(b) {
    ...
    for (let A = 0, D = E.length; A < D; A++) {
      const S = Array.isArray(E[A]) ? E[A] : [E[A]];
      for (let M = 0, C = S.length; M < C; M++) {
        const H = S[M],
          z = Array.isArray(H.value) ? H.value : [H.value];
    ...
    const R = y % L;
    return R > 0 && (y += L - R), (b.__size = y), (b.__cache = {}), this;
  }
  function x(b) {
...
class Kg {
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ("setAttribute" in t &&
          t.setAttribute("data-engine", `three.js r${za}`),
    ...
    function re() {
      (Ye = new sm(w)),
        ...
        (it = new Zp(w, Ye, e, ne)),
        (ge = new Bg(w, Ye)),
        it.reverseDepthBuffer && d && ge.buffers.depth.setReversed(!0),
        (Ge = new om(w)),
        (Ee = new bg()),
        (Ne = new zg(w, Ye, ge, Ee, it, ne, Ge)),
        (ft = new Qp(y)),
        (T = new im(y)),
        (_ = new dd(w)),
        (Pe = new jp(w, _)),
        ...
        (le = new cm(w, it, Ne)),
        (me = new Jp(Ee)),
        (j = new Tg(y, ft, T, Ye, it, Pe, me)),
        (V = new qg(y, Ee)),
        (_e = new wg()),
        (se = new Dg(Ye)),
        ($ = new Kp(y, ft, T, ge, W, p, c)),
        (xe = new Fg(y, W, it)),
        (P = new Yg(w, Ge, it, ge)),
        (Ae = new $p(w, Ye, Ge)),
        (be = new am(w, Ye, Ge)),
        (Ge.programs = j.programs),
        (y.capabilities = it),
        (y.extensions = Ye),
        (y.properties = Ee),
        (y.renderLists = _e),
    ...
    (this.xr = J),
      ...
      (this.setPixelRatio = function (v) {
        v !== void 0 && ((k = v), this.setSize(G, Z, !1));
      }),
      ...
      (this.setSize = function (v, U, O = !0) {
        ...
        (G = v),
          ...
          O === !0 && ((t.style.width = v + "px"), (t.style.height = U + "px")),
          this.setViewport(0, 0, v, U);
      }),
      (this.getDrawingBufferSize = function (v) {
        return v.set(G * k, Z * k).floor();
      }),
      ...
      (this.setViewport = function (v, U, O, B) {
        v.isVector4 ? ye.set(v.x, v.y, v.z, v.w) : ye.set(v, U, O, B),
          ge.viewport(C.copy(ye).multiplyScalar(k).round());
      }),
      (this.getScissor = function (v) {
        return v.copy(Oe);
      }),
      (this.setScissor = function (v, U, O, B) {
        v.isVector4 ? Oe.set(v.x, v.y, v.z, v.w) : Oe.set(v, U, O, B),
          ge.scissor(H.copy(Oe).multiplyScalar(k).round());
      }),
      (this.getScissorTest = function () {
        return tt;
      }),
      (this.setScissorTest = function (v) {
        ge.setScissorTest((tt = v));
      }),
      ...
      (this.clear = function (v = !0, U = !0, O = !0) {
        ...
        if (v) {
          let N = !1;
          if (D !== null) {
            const ee = D.texture.format;
            N = ee === qa || ee === Xa || ee === Wa;
          }
          if (N) {
            const ee = D.texture.type,
              ae =
                ee === ln ||
                ee === ii ||
                ee === ss ||
        ...
        U && (B |= w.DEPTH_BUFFER_BIT),
          O &&
            ((B |= w.STENCIL_BUFFER_BIT),
      ...
      (this.dispose = function () {
        t.removeEventListener("webglcontextlost", de, !1),
          ...
          j.dispose(),
          J.dispose(),
          J.removeEventListener("sessionstart", ao),
          J.removeEventListener("sessionend", oo),
          Wn.stop();
      });
    function de(v) {
      v.preventDefault(),
    ...
    function fe(v) {
      const U = v.target;
      U.removeEventListener("dispose", fe), Ie(U);
    }
    function Ie(v) {
      st(v), Ee.remove(v);
    }
    function st(v) {
      const U = Ee.get(v).programs;
      U !== void 0 &&
        (U.forEach(function (O) {
          j.releaseProgram(O);
        }),
        v.isShaderMaterial && j.releaseShaderCache(v));
    }
    this.renderBufferDirect = function (v, U, O, B, N, ee) {
      U === null && (U = ot);
      const ae = N.isMesh && N.matrixWorld.determinant() < 0,
        pe = Ul(v, U, O, B, N);
      ge.setMaterial(B, ae);
      let ue = O.index,
        Re = 1;
      if (B.wireframe === !0) {
        if (((ue = F.getWireframeAttribute(O)), ue === void 0)) return;
        Re = 2;
      }
      const Ce = O.drawRange,
        Se = O.attributes.position;
      let ke = Ce.start * Re,
        Je = (Ce.start + Ce.count) * Re;
      ee !== null &&
        ((ke = Math.max(ke, ee.start * Re)),
        (Je = Math.min(Je, (ee.start + ee.count) * Re))),
        ue !== null
          ? ((ke = Math.max(ke, 0)), (Je = Math.min(Je, ue.count)))
          : Se != null &&
            ((ke = Math.max(ke, 0)), (Je = Math.min(Je, Se.count)));
      const ht = Je - ke;
      if (ht < 0 || ht === 1 / 0) return;
      Pe.setup(N, B, pe, O, ue);
      let rt,
        nt = Ae;
      if (
        (ue !== null && ((rt = _.get(ue)), (nt = be), nt.setIndex(rt)),
        N.isMesh)
      )
        B.wireframe === !0
          ? (ge.setLineWidth(B.wireframeLinewidth * qe()), nt.setMode(w.LINES))
          : nt.setMode(w.TRIANGLES);
      else if (N.isLine) {
        let Te = B.linewidth;
        Te === void 0 && (Te = 1),
          ge.setLineWidth(Te * qe()),
          N.isLineSegments
            ? nt.setMode(w.LINES)
            : N.isLineLoop
            ? nt.setMode(w.LINE_LOOP)
            : nt.setMode(w.LINE_STRIP);
      } else
        N.isPoints
          ? nt.setMode(w.POINTS)
          : N.isSprite && nt.setMode(w.TRIANGLES);
      if (N.isBatchedMesh)
        if (N._multiDrawInstances !== null)
          ...
          const Te = N._multiDrawStarts,
            lt = N._multiDrawCounts,
            We = N._multiDrawCount,
            Ft = ue ? _.get(ue).bytesPerElement : 1,
            ri = Ee.get(B).currentProgram.getUniforms();
          for (let Ot = 0; Ot < We; Ot++)
            ri.setValue(w, "_gl_DrawID", Ot), nt.render(Te[Ot] / Ft, lt[Ot]);
        }
      else if (N.isInstancedMesh) nt.renderInstances(ke, ht, N.count);
      else if (O.isInstancedBufferGeometry) {
        const Te = O._maxInstanceCount !== void 0 ? O._maxInstanceCount : 1 / 0,
          lt = Math.min(O.instanceCount, Te);
        nt.renderInstances(ke, ht, lt);
      } else nt.render(ke, ht);
    };
    function je(v, U, O) {
      v.transparent === !0 && v.side === Qt && v.forceSinglePass === !1
        ? ((v.side = Nt),
          (v.needsUpdate = !0),
          gs(v, U, O),
          (v.side = wn),
    ...
    const Wn = new Ml();
    Wn.setAnimationLoop(fn),
      typeof self < "u" && Wn.setContext(self),
      (this.setAnimationLoop = function (v) {
        (jt = v), J.setAnimationLoop(v), v === null ? Wn.stop() : Wn.start();
      }),
      J.addEventListener("sessionstart", ao),
      J.addEventListener("sessionend", oo),
      (this.render = function (v, U) {
        ...
        if (
          ...
          J.enabled === !0 &&
            J.isPresenting === !0 &&
            (J.cameraAutoUpdate === !0 && J.updateCamera(U),
            (U = J.getCamera())),
          v.isScene === !0 && v.onBeforeRender(y, v, U, D),
          (f = se.get(v, E.length)),
          f.init(U),
          E.push(f),
          ...
          (te = me.init(this.clippingPlanes, ve)),
          (m = _e.get(v, b.length)),
          m.init(),
          b.push(m),
          ...
          ee !== null && cr(ee, U, -1 / 0, y.sortObjects);
        }
        cr(v, U, 0, y.sortObjects),
          m.finish(),
          y.sortObjects === !0 && m.sort(oe, he),
          (ct =
            J.enabled === !1 ||
            J.isPresenting === !1 ||
            J.hasDepthSensing() === !1),
          ct && $.addToRenderList(m, v),
        ...
        if ((f.setupLights(), U.isArrayCamera)) {
          ...
          for (let ae = 0, pe = ee.length; ae < pe; ae++) {
            const ue = ee[ae];
            co(m, v, ue, ue.viewport);
          }
        } else N.length > 0 && lo(B, N, v, U), ct && $.render(v), co(m, v, U);
        D !== null &&
          A === 0 &&
          (Ne.updateMultisampleRenderTarget(D), Ne.updateRenderTargetMipmap(D)),
          v.isScene === !0 && v.onAfterRender(y, v, U),
          ...
          E.length > 0
            ? ((f = E[E.length - 1]),
              te === !0 && me.setGlobalState(y.clippingPlanes, f.state.camera))
            : (f = null),
          b.pop(),
            ...
            (B &&
              (v.boundingSphere !== void 0
                ? (v.boundingSphere === null && v.computeBoundingSphere(),
                  we.copy(v.boundingSphere.center))
                : (ae.boundingSphere === null && ae.computeBoundingSphere(),
                  we.copy(ae.boundingSphere.center)),
              we.applyMatrix4(v.matrixWorld).applyMatrix4(Me)),
            Array.isArray(pe))
          ) {
            const ue = ae.groups;
            for (let Re = 0, Ce = ue.length; Re < Ce; Re++) {
              const Se = ue[Re],
                ke = pe[Se.materialIndex];
              ke && ke.visible && m.push(v, ae, ke, O, we.z, Se);
            }
          } else pe.visible && m.push(v, ae, pe, O, we.z, null);
        }
      }
      const ee = v.children;
      for (let ae = 0, pe = ee.length; ae < pe; ae++) cr(ee[ae], U, O, B);
    }
    function co(v, U, O, B) {
      const N = v.opaque,
        ee = v.transmissive,
        ae = v.transparent;
      f.setupLightsView(O),
        te === !0 && me.setGlobalState(y.clippingPlanes, O),
        B && ge.viewport(C.copy(B)),
        N.length > 0 && ms(N, U, O),
        ee.length > 0 && ms(ee, U, O),
        ae.length > 0 && ms(ae, U, O),
    ...
    function lo(v, U, O, B) {
      ...
      f.state.transmissionRenderTarget[B.id] === void 0 &&
        (f.state.transmissionRenderTarget[B.id] = new si(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      const ee = f.state.transmissionRenderTarget[B.id],
        ae = B.viewport || C;
      ee.setSize(
      ...
      const pe = y.getRenderTarget(),
        ue = y.getActiveCubeFace(),
        Re = y.getActiveMipmapLevel();
      y.setRenderTarget(ee),
        y.getClearColor(X),
        (K = y.getClearAlpha()),
        K < 1 && y.setClearColor(16777215, 0.5),
        y.clear(),
        ct && $.render(O);
      const Ce = y.toneMapping;
      y.toneMapping = zn;
      const Se = B.viewport;
      if (
        (B.viewport !== void 0 && (B.viewport = void 0),
        f.setupLightsView(B),
        te === !0 && me.setGlobalState(y.clippingPlanes, B),
        ms(v, O, B),
        Ne.updateMultisampleRenderTarget(ee),
        Ne.updateRenderTargetMipmap(ee),
        ...
        for (let Je = 0, ht = U.length; Je < ht; Je++) {
          const rt = U[Je],
            ...
            lt = rt.material,
            We = rt.group;
          if (lt.side === Qt && nt.layers.test(B.layers)) {
            const Ft = lt.side;
            (lt.side = Nt),
              (lt.needsUpdate = !0),
              uo(nt, O, B, Te, lt, We),
      ...
      y.setRenderTarget(pe, ue, Re),
        y.setClearColor(X, K),
        Se !== void 0 && (B.viewport = Se),
        (y.toneMapping = Ce);
    }
    function ms(v, U, O) {
      const B = U.isScene === !0 ? U.overrideMaterial : null;
      for (let N = 0, ee = v.length; N < ee; N++) {
        const ae = v[N],
          pe = ae.object,
          ue = ae.geometry,
          Re = ae.group;
        let Ce = ae.material;
        Ce.allowOverride === !0 && B !== null && (Ce = B),
          pe.layers.test(O.layers) && uo(pe, U, O, ue, Ce, Re);
      }
    }
    function uo(v, U, O, B, N, ee) {
      v.onBeforeRender(y, U, O, B, N, ee),
        ...
        N.onBeforeRender(y, U, O, B, v, ee),
        N.transparent === !0 && N.side === Qt && N.forceSinglePass === !1
          ? ((N.side = Nt),
            (N.needsUpdate = !0),
            y.renderBufferDirect(O, U, B, N, v, ee),
            (N.side = wn),
            (N.needsUpdate = !0),
            y.renderBufferDirect(O, U, B, N, v, ee),
            (N.side = Qt))
          : y.renderBufferDirect(O, U, B, N, v, ee),
        v.onAfterRender(y, U, O, B, N, ee);
    }
    function gs(v, U, O) {
      U.isScene !== !0 && (U = ot);
      const B = Ee.get(v),
        ...
        ae = N.state.version,
        pe = j.getParameters(v, N.state, ee, U, O),
        ue = j.getProgramCacheKey(pe);
      let Re = B.programs;
      (B.environment = v.isMeshStandardMaterial ? U.environment : null),
        (B.fog = U.fog),
        (B.envMap = (v.isMeshStandardMaterial ? T : ft).get(
        ...
        (B.envMapRotation =
          B.environment !== null && v.envMap === null
            ...
            : v.envMapRotation),
        Re === void 0 &&
          (v.addEventListener("dispose", fe),
          (Re = new Map()),
          (B.programs = Re));
      let Ce = Re.get(ue);
      if (Ce !== void 0) {
        if (B.currentProgram === Ce && B.lightsStateVersion === ae)
          return fo(v, pe), Ce;
      } else
        (pe.uniforms = j.getUniforms(v)),
          v.onBeforeCompile(pe, y),
          (Ce = j.acquireProgram(pe, ue)),
          Re.set(ue, Ce),
      ...
      return (
        ((!v.isShaderMaterial && !v.isRawShaderMaterial) ||
          v.clipping === !0) &&
          (Se.clippingPlanes = me.uniform),
        fo(v, pe),
        (B.needsLights = Fl(v)),
        (B.lightsStateVersion = ae),
        B.needsLights &&
          ((Se.ambientLightColor.value = N.state.ambient),
          (Se.lightProbe.value = N.state.probe),
          (Se.directionalLights.value = N.state.directional),
          (Se.directionalLightShadows.value = N.state.directionalShadow),
          (Se.spotLights.value = N.state.spot),
          (Se.spotLightShadows.value = N.state.spotShadow),
          (Se.rectAreaLights.value = N.state.rectArea),
          (Se.ltc_1.value = N.state.rectAreaLTC1),
          (Se.ltc_2.value = N.state.rectAreaLTC2),
          (Se.pointLights.value = N.state.point),
          (Se.pointLightShadows.value = N.state.pointShadow),
          (Se.hemisphereLights.value = N.state.hemi),
          (Se.directionalShadowMap.value = N.state.directionalShadowMap),
          (Se.directionalShadowMatrix.value = N.state.directionalShadowMatrix),
          (Se.spotShadowMap.value = N.state.spotShadowMap),
          (Se.spotLightMatrix.value = N.state.spotLightMatrix),
          (Se.spotLightMap.value = N.state.spotLightMap),
          (Se.pointShadowMap.value = N.state.pointShadowMap),
          (Se.pointShadowMatrix.value = N.state.pointShadowMatrix)),
        (B.currentProgram = Ce),
        (B.uniformsList = null),
        Ce
      );
    ...
    function fo(v, U) {
      ...
      (O.outputColorSpace = U.outputColorSpace),
        ...
        (O.batchingColor = U.batchingColor),
        (O.instancing = U.instancing),
        (O.instancingColor = U.instancingColor),
        (O.instancingMorph = U.instancingMorph),
        (O.skinning = U.skinning),
        (O.morphTargets = U.morphTargets),
        (O.morphNormals = U.morphNormals),
        (O.morphColors = U.morphColors),
        (O.morphTargetsCount = U.morphTargetsCount),
        (O.numClippingPlanes = U.numClippingPlanes),
        (O.numIntersection = U.numClipIntersection),
        (O.vertexAlphas = U.vertexAlphas),
        (O.vertexTangents = U.vertexTangents),
        (O.toneMapping = U.toneMapping);
    }
    function Ul(v, U, O, B, N) {
      U.isScene !== !0 && (U = ot), Ne.resetTextureUnits();
      const ee = U.fog,
        ae = B.isMeshStandardMaterial ? U.environment : null,
        pe =
          D === null
            ? y.outputColorSpace
            ...
            : It,
        ue = (B.isMeshStandardMaterial ? T : ft).get(B.envMap || ae),
        Re =
          B.vertexColors === !0 &&
          !!O.attributes.color &&
          O.attributes.color.itemSize === 4,
        Ce = !!O.attributes.tangent && (!!B.normalMap || B.anisotropy > 0),
        Se = !!O.morphAttributes.position,
        ke = !!O.morphAttributes.normal,
        Je = !!O.morphAttributes.color;
      let ht = zn;
      B.toneMapped &&
      ...
      B.version === Te.__version
        ? ((Te.needsLights && Te.lightsStateVersion !== lt.state.version) ||
            ...
            (Te.numClippingPlanes !== void 0 &&
              (Te.numClippingPlanes !== me.numPlanes ||
                Te.numIntersection !== me.numIntersection)) ||
            Te.vertexAlphas !== Re ||
            ...
            Te.morphColors !== Je ||
            Te.toneMapping !== ht ||
            Te.morphTargetsCount !== nt) &&
          (We = !0)
        : ((We = !0), (Te.__version = B.version));
      let Ft = Te.currentProgram;
      We === !0 && (Ft = gs(B, U, N));
      let ri = !1,
        Ot = !1,
        Gi = !1;
      const at = Ft.getUniforms(),
        kt = Te.uniforms;
      if (
        (ge.useProgram(Ft.program) && ((ri = !0), (Ot = !0), (Gi = !0)),
        B.id !== S && ((S = B.id), (Ot = !0)),
        ri || M !== v)
      ) {
        ge.buffers.depth.getReversed()
          ? (ce.copy(v.projectionMatrix),
            qu(ce),
            Yu(ce),
            at.setValue(w, "projectionMatrix", ce))
          : at.setValue(w, "projectionMatrix", v.projectionMatrix),
          at.setValue(w, "viewMatrix", v.matrixWorldInverse);
        const Dt = at.map.cameraPosition;
        Dt !== void 0 &&
          Dt.setValue(w, Xe.setFromMatrixPosition(v.matrixWorld)),
          ...
          (B.isMeshPhongMaterial ||
            ...
            B.isShaderMaterial) &&
            at.setValue(w, "isOrthographic", v.isOrthographicCamera === !0),
          M !== v && ((M = v), (Ot = !0), (Gi = !0));
      }
      if (N.isSkinnedMesh) {
        at.setOptional(w, N, "bindMatrix"),
          at.setOptional(w, N, "bindMatrixInverse");
        const bt = N.skeleton;
        bt &&
          (bt.boneTexture === null && bt.computeBoneTexture(),
          at.setValue(w, "boneTexture", bt.boneTexture, Ne));
      }
      N.isBatchedMesh &&
        (at.setOptional(w, N, "batchingTexture"),
        at.setValue(w, "batchingTexture", N._matricesTexture, Ne),
        at.setOptional(w, N, "batchingIdTexture"),
        at.setValue(w, "batchingIdTexture", N._indirectTexture, Ne),
        at.setOptional(w, N, "batchingColorTexture"),
        N._colorsTexture !== null &&
          at.setValue(w, "batchingColorTexture", N._colorsTexture, Ne));
      ...
      if (
        ((Vt.position !== void 0 ||
          ...
          Vt.color !== void 0) &&
          le.update(N, O, Ft),
        (Ot || Te.receiveShadow !== N.receiveShadow) &&
          ((Te.receiveShadow = N.receiveShadow),
          at.setValue(w, "receiveShadow", N.receiveShadow)),
        ...
        B.isMeshStandardMaterial &&
          B.envMap === null &&
          U.environment !== null &&
          (kt.envMapIntensity.value = U.environmentIntensity),
        Ot &&
          (at.setValue(w, "toneMappingExposure", y.toneMappingExposure),
          Te.needsLights && Nl(kt, Gi),
          ee && B.fog === !0 && V.refreshFogUniforms(kt, ee),
          V.refreshMaterialUniforms(
            kt,
            B,
            k,
            Z,
          ...
          Zs.upload(w, ho(Te), kt, Ne)),
        B.isShaderMaterial &&
          B.uniformsNeedUpdate === !0 &&
          (Zs.upload(w, ho(Te), kt, Ne), (B.uniformsNeedUpdate = !1)),
        B.isSpriteMaterial && at.setValue(w, "center", N.center),
        at.setValue(w, "modelViewMatrix", N.modelViewMatrix),
        at.setValue(w, "normalMatrix", N.normalMatrix),
        at.setValue(w, "modelMatrix", N.matrixWorld),
        B.isShaderMaterial || B.isRawShaderMaterial)
      ) {
        const bt = B.uniformsGroups;
        for (let Dt = 0, lr = bt.length; Dt < lr; Dt++) {
          const Xn = bt[Dt];
          P.update(Xn, Ft), P.bind(Xn, Ft);
        }
      }
      return Ft;
    }
    ...
    (this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (v, U, O) {
        ...
        (B.__autoAllocateDepthBuffer = v.resolveDepthBuffer === !1),
          ...
          (Ee.get(v.texture).__webglTexture = U),
          (Ee.get(v.depthTexture).__webglTexture = B.__autoAllocateDepthBuffer
            ? void 0
            : O),
    ...
    (this.setRenderTarget = function (v, U = 0, O = 0) {
      ...
      if (v) {
        ...
        if (ue.__useDefaultFramebuffer !== void 0)
          ge.bindFramebuffer(w.FRAMEBUFFER, null), (B = !1);
        else if (ue.__webglFramebuffer === void 0) Ne.setupRenderTarget(v);
        else if (ue.__hasExternalTextures)
          Ne.rebindTextures(
            v,
            Ee.get(v.texture).__webglTexture,
            Ee.get(v.depthTexture).__webglTexture
          );
        else if (v.depthBuffer) {
          const Se = v.depthTexture;
          if (ue.__boundDepthTexture !== Se) {
            if (
              Se !== null &&
              Ee.has(Se) &&
              (v.width !== Se.image.width || v.height !== Se.image.height)
            )
              throw new Error(
                "WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size."
              );
            Ne.setupDepthRenderbuffer(v);
          }
        }
        const Re = v.texture;
        (Re.isData3DTexture ||
          Re.isDataArrayTexture ||
          Re.isCompressedArrayTexture) &&
          (ae = !0);
        const Ce = Ee.get(v).__webglFramebuffer;
        v.isWebGLCubeRenderTarget
          ? (Array.isArray(Ce[U]) ? (N = Ce[U][O]) : (N = Ce[U]), (ee = !0))
          : v.samples > 0 && Ne.useMultisampledRTT(v) === !1
          ? (N = Ee.get(v).__webglMultisampledFramebuffer)
          : Array.isArray(Ce)
          ? (N = Ce[O])
          : (N = Ce),
          C.copy(v.viewport),
        ...
        C.copy(ye).multiplyScalar(k).floor(),
          H.copy(Oe).multiplyScalar(k).floor(),
          (z = tt);
      if (
        (O !== 0 && (N = Ol),
        ge.bindFramebuffer(w.FRAMEBUFFER, N) && B && ge.drawBuffers(v, N),
        ge.viewport(C),
        ge.scissor(H),
        ge.setScissorTest(z),
        ee)
      ) {
        const ue = Ee.get(v.texture);
        w.framebufferTexture2D(
          w.FRAMEBUFFER,
          w.COLOR_ATTACHMENT0,
          w.TEXTURE_CUBE_MAP_POSITIVE_X + U,
          ue.__webglTexture,
          O
        );
      } else if (ae) {
      ...
      (this.readRenderTargetPixels = function (v, U, O, B, N, ee, ae, pe = 0) {
        ...
        let ue = Ee.get(v).__webglFramebuffer;
        if ((v.isWebGLCubeRenderTarget && ae !== void 0 && (ue = ue[ae]), ue)) {
          ge.bindFramebuffer(w.FRAMEBUFFER, ue);
          try {
            const Re = v.textures[pe],
              Ce = Re.format,
              Se = Re.type;
            if (!it.textureFormatReadable(Ce)) {
              console.error(
                "THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format."
              );
              return;
            }
            if (!it.textureTypeReadable(Se)) {
              console.error(
            ...
            U >= 0 &&
              ...
              O >= 0 &&
              O <= v.height - N &&
              (v.textures.length > 1 && w.readBuffer(w.COLOR_ATTACHMENT0 + pe),
              w.readPixels(U, O, B, N, ne.convert(Ce), ne.convert(Se), ee));
          } finally {
            const Re = D !== null ? Ee.get(D).__webglFramebuffer : null;
            ge.bindFramebuffer(w.FRAMEBUFFER, Re);
          }
        }
      }),
      (this.readRenderTargetPixelsAsync = async function (
        ...
        if ((v.isWebGLCubeRenderTarget && ae !== void 0 && (ue = ue[ae]), ue))
          if (U >= 0 && U <= v.width - B && O >= 0 && O <= v.height - N) {
            ...
            const ke = w.createBuffer();
            w.bindBuffer(w.PIXEL_PACK_BUFFER, ke),
              w.bufferData(w.PIXEL_PACK_BUFFER, ee.byteLength, w.STREAM_READ),
              v.textures.length > 1 && w.readBuffer(w.COLOR_ATTACHMENT0 + pe),
              w.readPixels(U, O, B, N, ne.convert(Ce), ne.convert(Se), 0);
            const Je = D !== null ? Ee.get(D).__webglFramebuffer : null;
            ge.bindFramebuffer(w.FRAMEBUFFER, Je);
      ...
      (this.copyFramebufferToTexture = function (v, U = null, O = 0) {
        const B = Math.pow(2, -O),
          N = Math.floor(v.image.width * B),
          ee = Math.floor(v.image.height * B),
          ae = U !== null ? U.x : 0,
          pe = U !== null ? U.y : 0;
        Ne.setTexture2D(v, 0),
          w.copyTexSubImage2D(w.TEXTURE_2D, O, 0, 0, ae, pe, N, ee),
          ge.unbindTexture();
      });
    const Bl = w.createFramebuffer(),
      zl = w.createFramebuffer();
    (this.copyTextureToTexture = function (
      ...
      ee === null &&
        (N !== 0
          ? (Ti(
            ...
            (N = 0))
          : (ee = 0));
      let ae, pe, ue, Re, Ce, Se, ke, Je, ht;
      const rt = v.isCompressedTexture ? v.mipmaps[ee] : v.image;
      if (O !== null)
        (ae = O.max.x - O.min.x),
          (pe = O.max.y - O.min.y),
          (ue = O.isBox3 ? O.max.z - O.min.z : 1),
          (Re = O.min.x),
          (Ce = O.min.y),
          (Se = O.isBox3 ? O.min.z : 0);
      else {
        const Vt = Math.pow(2, -N);
        (ae = Math.floor(rt.width * Vt)),
          (pe = Math.floor(rt.height * Vt)),
          v.isDataArrayTexture
            ? (ue = rt.depth)
            : v.isData3DTexture
            ? (ue = Math.floor(rt.depth * Vt))
            : (ue = 1),
          (Re = 0),
          (Ce = 0),
          (Se = 0);
      ...
      B !== null
        ? ((ke = B.x), (Je = B.y), (ht = B.z))
        : ((ke = 0), (Je = 0), (ht = 0));
      const nt = ne.convert(U.format),
        Te = ne.convert(U.type);
      let lt;
      U.isData3DTexture
        ? (Ne.setTexture3D(U, 0), (lt = w.TEXTURE_3D))
        : U.isDataArrayTexture || U.isCompressedArrayTexture
        ? (Ne.setTexture2DArray(U, 0), (lt = w.TEXTURE_2D_ARRAY))
        : (Ne.setTexture2D(U, 0), (lt = w.TEXTURE_2D)),
        w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL, U.flipY),
        w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL, U.premultiplyAlpha),
        w.pixelStorei(w.UNPACK_ALIGNMENT, U.unpackAlignment);
      const We = w.getParameter(w.UNPACK_ROW_LENGTH),
        Ft = w.getParameter(w.UNPACK_IMAGE_HEIGHT),
        ri = w.getParameter(w.UNPACK_SKIP_PIXELS),
        Ot = w.getParameter(w.UNPACK_SKIP_ROWS),
        Gi = w.getParameter(w.UNPACK_SKIP_IMAGES);
      w.pixelStorei(w.UNPACK_ROW_LENGTH, rt.width),
        w.pixelStorei(w.UNPACK_IMAGE_HEIGHT, rt.height),
        w.pixelStorei(w.UNPACK_SKIP_PIXELS, Re),
        w.pixelStorei(w.UNPACK_SKIP_ROWS, Ce),
        w.pixelStorei(w.UNPACK_SKIP_IMAGES, Se);
      const at = v.isDataArrayTexture || v.isData3DTexture,
        kt = U.isDataArrayTexture || U.isData3DTexture;
      if (v.isDepthTexture) {
        const Vt = Ee.get(v),
          bt = Ee.get(U),
          Dt = Ee.get(Vt.__renderTarget),
          lr = Ee.get(bt.__renderTarget);
        ge.bindFramebuffer(w.READ_FRAMEBUFFER, Dt.__webglFramebuffer),
          ge.bindFramebuffer(w.DRAW_FRAMEBUFFER, lr.__webglFramebuffer);
        for (let Xn = 0; Xn < ue; Xn++)
          at &&
            (w.framebufferTextureLayer(
              w.READ_FRAMEBUFFER,
              w.COLOR_ATTACHMENT0,
              Ee.get(v).__webglTexture,
              N,
              Se + Xn
            ),
            w.framebufferTextureLayer(
        ...
        ge.bindFramebuffer(w.READ_FRAMEBUFFER, null),
          ge.bindFramebuffer(w.DRAW_FRAMEBUFFER, null);
      } else if (N !== 0 || v.isRenderTargetTexture || Ee.has(v)) {
        const Vt = Ee.get(v),
          bt = Ee.get(U);
        ge.bindFramebuffer(w.READ_FRAMEBUFFER, Bl),
          ge.bindFramebuffer(w.DRAW_FRAMEBUFFER, zl);
        for (let Dt = 0; Dt < ue; Dt++)
          at
            ? w.framebufferTextureLayer(
                w.READ_FRAMEBUFFER,
                w.COLOR_ATTACHMENT0,
            ...
            N !== 0
              ...
              : kt
              ? w.copyTexSubImage3D(lt, ee, ke, Je, ht + Dt, Re, Ce, ae, pe)
              : w.copyTexSubImage2D(lt, ee, ke, Je, Re, Ce, ae, pe);
        ge.bindFramebuffer(w.READ_FRAMEBUFFER, null),
          ge.bindFramebuffer(w.DRAW_FRAMEBUFFER, null);
      } else
        kt
          ? v.isDataTexture || v.isData3DTexture
            ? w.texSubImage3D(lt, ee, ke, Je, ht, ae, pe, ue, nt, Te, rt.data)
            ...
            : w.texSubImage3D(lt, ee, ke, Je, ht, ae, pe, ue, nt, Te, rt)
          : v.isDataTexture
          ? w.texSubImage2D(w.TEXTURE_2D, ee, ke, Je, ae, pe, nt, Te, rt.data)
          ...
          : w.texSubImage2D(w.TEXTURE_2D, ee, ke, Je, ae, pe, nt, Te, rt);
      w.pixelStorei(w.UNPACK_ROW_LENGTH, We),
        w.pixelStorei(w.UNPACK_IMAGE_HEIGHT, Ft),
        w.pixelStorei(w.UNPACK_SKIP_PIXELS, ri),
        w.pixelStorei(w.UNPACK_SKIP_ROWS, Ot),
        w.pixelStorei(w.UNPACK_SKIP_IMAGES, Gi),
        ee === 0 && U.generateMipmaps && w.generateMipmap(lt),
        ge.unbindTexture();
    }),
      (this.copyTextureToTexture3D = function (
        ...
        return (
          ...
          this.copyTextureToTexture(v, U, O, B, N)
        );
      }),
      (this.initRenderTarget = function (v) {
        Ee.get(v).__webglFramebuffer === void 0 && Ne.setupRenderTarget(v);
      }),
      (this.initTexture = function (v) {
        v.isCubeTexture
          ? Ne.setTextureCube(v, 0)
          : v.isData3DTexture
          ? Ne.setTexture3D(v, 0)
          : v.isDataArrayTexture || v.isCompressedArrayTexture
          ? Ne.setTexture2DArray(v, 0)
          : Ne.setTexture2D(v, 0),
          ge.unbindTexture();
      }),
      (this.resetState = function () {
        (R = 0), (A = 0), (D = null), ge.reset(), Pe.reset();
      }),
      typeof __THREE_DEVTOOLS__ < "u" &&
        __THREE_DEVTOOLS__.dispatchEvent(
          new CustomEvent("observe", { detail: this })
  ...
  set outputColorSpace(e) {
    ...
    (t.drawingBufferColorSpace = Ve._getDrawingBufferColorSpace(e)),
      (t.unpackColorSpace = Ve._getUnpackColorSpace());
  }
}
function Dc(s, e) {
  if (e === gu)
...
class bl extends ki {
  ...
  load(e, t, n, i) {
    ...
    if (this.resourcePath !== "") a = this.resourcePath;
      ...
      a = is.resolveURL(l, this.path);
    } else a = is.extractUrlBase(e);
    this.manager.itemStart(e);
    const o = function (l) {
  ...
  parse(e, t, n, i) {
    ...
    if (typeof e == "string") r = JSON.parse(e);
      ...
      if (c.decode(new Uint8Array(e, 0, 4)) === Al) {
        try {
          a[ze.KHR_BINARY_GLTF] = new p_(e);
        } catch (h) {
          i && i(h);
          return;
        }
...
class $g {
  constructor(e) {
    (this.parser = e),
      (this.name = ze.KHR_LIGHTS_PUNCTUAL),
  ...
  _loadLight(e) {
    ...
    c.color !== void 0 && u.setRGB(c.color[0], c.color[1], c.color[2], It);
    const h = c.range !== void 0 ? c.range : 0;
    switch (c.type) {
      case "directional":
        (l = new $s(u)), l.target.position.set(0, 0, -1), l.add(l.target);
        break;
      case "point":
        (l = new vl(u)), (l.distance = h);
        break;
      case "spot":
        (l = new Kh(u)),
          (l.distance = h),
  ...
  extendParams(e, t, n) {
    ...
    if (r) {
      ...
      r.baseColorTexture !== void 0 &&
        i.push(n.assignTexture(e, "map", r.baseColorTexture, vt));
    }
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      ...
      a.sheenColorTexture !== void 0 &&
        r.push(n.assignTexture(t, "sheenColorMap", a.sheenColorTexture, vt)),
...
class s_ {
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      (t.attenuationColor = new Le().setRGB(o[0], o[1], o[2], It)),
      Promise.all(r)
    );
  }
}
...
class a_ {
  ...
  extendMaterialParams(e, t) {
    ...
    return (
      (t.specularColor = new Le().setRGB(o[0], o[1], o[2], It)),
      a.specularColorTexture !== void 0 &&
        r.push(
          n.assignTexture(t, "specularColorMap", a.specularColorTexture, vt)
        ),
      Promise.all(r)
    );
  }
        ...
        Promise.all(o).then((l) => {
          ...
          for (const g of h) {
            const x = new De(),
              ...
              f = new Gn(),
              b = new I(1, 1, 1),
              E = new Th(g.geometry, g.material, d);
            for (let y = 0; y < d; y++)
              c.TRANSLATION && m.fromBufferAttribute(c.TRANSLATION, y),
                c.ROTATION && f.fromBufferAttribute(c.ROTATION, y),
                c.SCALE && b.fromBufferAttribute(c.SCALE, y),
                E.setMatrixAt(y, x.compose(m, f, b));
            for (const y in c)
              if (y === "_COLOR_0") {
                const L = c[y];
                E.instanceColor = new Da(L.array, L.itemSize, L.normalized);
              } else
                y !== "TRANSLATION" &&
                  y !== "ROTATION" &&
                  y !== "SCALE" &&
                  g.geometry.setAttribute(y, c[y]);
            ut.prototype.copy.call(E, g),
...
const Al = "glTF",
  Ji = 12,
  Uc = { JSON: 1313821514, BIN: 5130562 };
class p_ {
  constructor(e) {
...
class m_ {
  constructor(e, t) {
    ...
    (this.name = ze.KHR_DRACO_MESH_COMPRESSION),
      (this.json = e),
      (this.dracoLoader = t),
...
class v_ extends wl {
  interpolate_(e, t, n, i) {
    ...
    return x_.fromArray(r).normalize().toArray(r), r;
  }
}
const Xt = {
    POINTS: 0,
  ...
  Nc = { 9728: Pt, 9729: Ht, 9984: qc, 9985: Ws, 9986: Qi, 9987: Sn },
  Fc = { 33071: Fn, 33648: Js, 10497: Li },
  Xr = { SCALAR: 1, VEC2: 2, VEC3: 3, VEC4: 4, MAT2: 4, MAT3: 9, MAT4: 16 },
  Oa = {
    POSITION: "position",
    NORMAL: "normal",
    TANGENT: "tangent",
  ...
  M_ = { CUBICSPLINE: void 0, LINEAR: ls, STEP: cs },
  qr = { OPAQUE: "OPAQUE", MASK: "MASK", BLEND: "BLEND" };
function y_(s) {
  return (
    s.DefaultMaterial === void 0 &&
      (s.DefaultMaterial = new rr({
        color: 16777215,
        emissive: 0,
        metalness: 1,
        roughness: 1,
...
function T_(s) {
  ...
  if (
    (t
      ? (e = "draco:" + t.bufferView + ":" + t.indices + ":" + Yr(t.attributes))
      : (e = s.indices + ":" + Yr(s.attributes) + ":" + s.mode),
    s.targets !== void 0)
  )
...
class w_ {
  constructor(e = {}, t = {}) {
    ...
    typeof createImageBitmap > "u" || (n && i < 17) || (r && a < 98)
      ? (this.textureLoader = new qh(this.options.manager))
      : (this.textureLoader = new Jh(this.options.manager)),
      this.textureLoader.setCrossOrigin(this.options.crossOrigin),
      this.textureLoader.setRequestHeader(this.options.requestHeader),
      (this.fileLoader = new xl(this.options.manager)),
      ...
      Promise.all(r).then(function (a) {
        ...
        if (p && p !== h) {
          ...
          E ||
            ...
            t.cache.add(b, E)),
            (m = new $a(E, c, (d % p) / u, g));
        } else o === null ? (x = new l(i.count * c)) : (x = new l(o, d, i.count * c)), (m = new Lt(x, c, g));
        if (i.sparse !== void 0) {
          const f = Xr.SCALAR,
            b = Ai[i.sparse.indices.componentType],
            E = i.sparse.indices.byteOffset || 0,
            y = i.sparse.values.byteOffset || 0,
            L = new b(a[1], E, i.sparse.count * f),
            R = new l(a[2], y, i.sparse.count * c);
          o !== null && (m = new Lt(m.array.slice(), m.itemSize, m.normalized)),
            (m.normalized = !1);
          for (let A = 0, D = L.length; A < D; A++) {
            const S = L[A];
            if (
              (m.setX(S, R[A * c]),
              c >= 2 && m.setY(S, R[A * c + 1]),
              c >= 3 && m.setZ(S, R[A * c + 2]),
              c >= 4 && m.setW(S, R[A * c + 3]),
              c >= 5)
            )
              throw new Error(
  ...
  loadTextureImage(e, t, n) {
    ...
    const l = this.loadImageSource(t, n)
      .then(function (u) {
        ...
        return (
          (u.magFilter = Nc[d.magFilter] || Ht),
          (u.minFilter = Nc[d.minFilter] || Sn),
          (u.wrapS = Fc[d.wrapS] || Li),
          (u.wrapT = Fc[d.wrapT] || Li),
          (u.generateMipmaps =
            !u.isCompressedTexture && u.minFilter !== Pt && u.minFilter !== Ht),
      ...
      .then(function (h) {
        return new Promise(function (d, p) {
          ...
          t.isImageBitmapLoader === !0 &&
            ...
            t.load(is.resolveURL(h, r.path), g, void 0, p);
        });
      })
      .then(function (h) {
        return (
  ...
  assignTexture(e, t, n, i) {
    ...
    return this.getDependency("texture", n.index).then(function (a) {
      ...
      if (
        ...
        r.extensions[ze.KHR_TEXTURE_TRANSFORM])
      ) {
        const o =
          n.extensions !== void 0
            ? n.extensions[ze.KHR_TEXTURE_TRANSFORM]
            : void 0;
        if (o) {
          const c = r.associations.get(a);
          (a = r.extensions[ze.KHR_TEXTURE_TRANSFORM].extendTexture(a, o)),
  ...
  loadMaterial(e) {
    ...
    if (c[ze.KHR_MATERIALS_UNLIT]) {
      ...
      if (
        ...
        o.color.setRGB(d[0], d[1], d[2], It), (o.opacity = d[3]);
      }
      h.baseColorTexture !== void 0 &&
        l.push(t.assignTexture(o, "map", h.baseColorTexture, vt)),
    ...
    r.doubleSided === !0 && (o.side = Qt);
    const u = r.alphaMode || qr.OPAQUE;
    if (
      (u === qr.BLEND
    ...
    if (
      ...
      r.emissiveFactor !== void 0 && a !== Tn)
    ) {
      const h = r.emissiveFactor;
      o.emissive = new Le().setRGB(h[0], h[1], h[2], It);
    }
    return (
      r.emissiveTexture !== void 0 &&
        a !== Tn &&
        l.push(t.assignTexture(o, "emissiveMap", r.emissiveTexture, vt)),
  ...
  loadGeometries(e) {
    ...
    function r(o) {
      return n[ze.KHR_DRACO_MESH_COMPRESSION]
        .decodePrimitive(o, t)
        .then(function (c) {
          return Oc(c, o, t);
        });
    ...
    for (let o = 0, c = e.length; o < c; o++) {
      ...
      if (h) a.push(h.promise);
        ...
        let d;
        l.extensions && l.extensions[ze.KHR_DRACO_MESH_COMPRESSION]
          ? (d = r(l))
          : (d = Oc(new rn(), l, t)),
    ...
    return (
      ...
      Promise.all(o).then(function (c) {
        ...
        for (let p = 0, g = u.length; p < g; p++) {
          ...
          if (
            m.mode === Xt.TRIANGLES ||
            m.mode === Xt.TRIANGLE_STRIP ||
            m.mode === Xt.TRIANGLE_FAN ||
            m.mode === void 0
          )
            (f = r.isSkinnedMesh === !0 ? new yh(x, b) : new Et(x, b)),
              f.isSkinnedMesh === !0 && f.normalizeSkinWeights(),
              m.mode === Xt.TRIANGLE_STRIP
                ? (f.geometry = Dc(f.geometry, el))
                : m.mode === Xt.TRIANGLE_FAN &&
                  (f.geometry = Dc(f.geometry, La));
          else if (m.mode === Xt.LINES) f = new Rh(x, b);
          else if (m.mode === Xt.LINE_STRIP) f = new Qa(x, b);
          else if (m.mode === Xt.LINE_LOOP) f = new Ch(x, b);
          else if (m.mode === Xt.POINTS) f = new Ph(x, b);
          else
            throw new Error(
          ...
          Object.keys(f.geometry.morphAttributes).length > 0 && E_(f, r),
            ...
            yn(f, r),
            m.extensions && Jn(i, f, m),
            t.assignFinalMaterial(f),
            h.push(f);
        }
        for (let p = 0, g = h.length; p < g; p++)
          t.associations.set(h[p], { meshes: e, primitives: p });
        if (h.length === 1) return r.extensions && Jn(i, h[0], r), h[0];
        const d = new On();
  ...
  loadAnimation(e) {
    ...
    return Promise.all([
      ...
      for (let b = 0, E = d.length; b < E; b++) {
        ...
        const S = n._createAnimationTracks(y, L, R, A, D);
        if (S) for (let M = 0; M < S.length; M++) f.push(S[M]);
      }
      return new zh(r, void 0, f);
    });
  }
  createNodeMesh(e) {
    const t = this.json,
    ...
    return Promise.all(o).then(function (c) {
      ...
      const l = (u) => {
        ...
        for (const [d, p] of i.associations)
          (d instanceof cn || d instanceof Mt) && h.set(d, p);
        return (
          u.traverse((d) => {
  ...
  _createAnimationTracks(e, t, n, i, r) {
    ...
    const u = i.interpolation !== void 0 ? M_[i.interpolation] : ls,
      h = this._getArrayFromAccessor(n);
    for (let d = 0, p = c.length; d < p; d++) {
      const g = new l(c[d] + "." + Un[r.path], t.array, h, u);
  ...
  _createCubicSplineTrackInterpolant(e) {
    (e.createInterpolant = function (n) {
      const i = this instanceof Ni ? v_ : wl;
...
function R_(s, e, t) {
  ...
  if (n.POSITION !== void 0) {
    ...
    if (c !== void 0 && l !== void 0) {
      if (
        (i.set(new I(c[0], c[1], c[2]), new I(l[0], l[1], l[2])), o.normalized)
      ) {
        const u = Ba(Ai[o.componentType]);
...
function Oc(s, e, t) {
  ...
  return (
    Ve.workingColorSpace !== It &&
      "COLOR_0" in n &&
      console.warn(
        `THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Ve.workingColorSpace}" not supported.`
      ),
    yn(s, e),
    R_(s, e, t),
    Promise.all(i).then(function () {
      return e.targets !== void 0 ? S_(s, e.targets, t) : s;
    })
  );
}
let mt,
  ...
  Ut,
  kn = new On();
kn.rotation.x = (-3 * Math.PI) / 4;
kn.userData.rotate = !1;
let C_ = new ed(),
  ir = new ud(),
  wi = new He(),
  Cl = [],
...
function I_() {
  (mt = new xh()),
    (mt.background = new Le(0)),
    (Hn = new Rt(75, window.innerWidth / window.innerHeight, 0.1, 1e3)),
    Hn.position.set(0, 0, 10),
    (Wt = new Kg({ antialias: !0 })),
    Wt.setSize(window.innerWidth, window.innerHeight),
    (Wt.shadowMap.enabled = !0),
    (Wt.shadowMap.type = Vc),
    (Wt.outputColorSpace = vt),
    (Wt.toneMapping = Wc),
    (Wt.toneMappingExposure = 1),
    (Wt.physicallyCorrectLights = !0);
  const s = new Zh(16777215, 1.5);
  mt.add(s);
  const e = new $s(16777215, 3);
  e.position.set(0, 5, 5), (e.castShadow = !1), mt.add(e);
  const t = new $s(16777215, 2);
  t.position.set(-5, 5, 0), mt.add(t);
  const n = new $s(16777215, 2);
  n.position.set(5, -5, 0), mt.add(n);
  const i = new vl(16777215, 3, 50);
  i.position.set(0, 3, 2),
    mt.add(i),
    H_(),
    ...
    V_(),
    (Hn.position.z = 5);
  const r = Wt.domElement;
  r.addEventListener("mousedown", G_, !1),
    r.addEventListener("mousemove", W_, !1),
    r.addEventListener("mouseup", zc, !1),
    r.addEventListener("mouseleave", zc, !1),
    r.addEventListener("touchstart", X_, !1),
    r.addEventListener("touchmove", q_, !1),
    r.addEventListener("touchend", Hc, !1),
    r.addEventListener("touchcancel", Hc, !1),
    window.addEventListener("resize", K_, !1),
    Dl();
}
function D_() {
  new bl().load(
    ...
    (e) => {
      console.log("GLB model loaded successfully"),
        ...
        et.position.set(0, 2, 0),
        (et.userData = { shouldMove: !1 }),
        et.traverse((o) => {
          o.isMesh &&
            (Array.isArray(o.material) ? o.material : [o.material]).forEach(
              (l) => {
                (l.roughness = 0.5), (l.metalness = 0), (l.needsUpdate = !0);
              }
            );
        }),
        mt.add(et),
        console.log("Rose model added to scene");
      const t = new Kt().setFromObject(et),
        n = t.getSize(new I()),
        i = t.getCenter(new I()),
        r = new Bi(n.x, n.y, n.z),
        a = new Tn({ visible: !1 });
      (Ut = new Et(r, a)), Ut.position.copy(i), mt.add(Ut);
    },
    (e) => {
...
function U_() {
  new bl().load(
    "/happy-birthday/models/pot.glb",
    (e) => {
      console.log("Pot GLB model loaded successfully."),
        (Ct = e.scene),
        Ct.position.set(0, -2, 0),
        Ct.scale.set(0.005, 0.005, 0.005),
        Ct.traverse((t) => {
          t.isMesh &&
            (console.log("Found mesh in pot:", t.name),
            (t.castShadow = !0),
            (t.receiveShadow = !0),
            t.material &&
              (console.log("Pot material:", t.material.name),
              console.log("  - Type:", t.material.type),
              console.log("  - Diffuse Map (Texture):", t.material.map)));
        }),
        mt.add(Ct);
    },
    (e) => {
      console.log(`Pot model: ${(e.loaded / e.total) * 100}% loaded`);
    },
    (e) => {
      console.error("An error happened while loading the pot GLB model:", e),
        N_();
    }
  );
}
function N_() {
  ...
  const s = new eo(0.5, 0.5, 0.5, 32),
    e = new rr({ color: 9127187 });
  (Ct = new Et(s, e)), Ct.position.set(0, -1, 0), mt.add(Ct);
}
function F_() {
  ...
  (e.innerHTML = "×"),
    ...
    (e.onclick = async () => {
      s.style.display = "none";
      const i = document.getElementById("youtubePlayer");
      i &&
        i.contentWindow &&
    ...
    const r = (i / s) * Math.PI * 2,
      ...
      o =
        ...
        (13 * Math.cos(r) -
          ...
          2 * Math.cos(3 * r) -
          Math.cos(4 * r));
    t.push(new I(a * 0.05, 0, o * 0.05));
  }
  const n = -3;
  for (let i = 0; i < s; i++) {
    const r = et.clone();
    r.position.set(0, n, 0), r.scale.set(0.2, 0.2, 0.2), kn.add(r), Cl.push(r);
  }
  mt.add(kn),
    et && mt.remove(et),
    Ut && mt.remove(Ut),
...
async function B_(s) {
  if (!Bc) {
    ...
    for (let e = 0; e < s.length; e++) {
      ...
      const i = new I(n.x, 0, n.z).normalize(),
        r = new I().addVectors(n, i);
      t.lookAt(r), await new Promise((a) => setTimeout(a, P_));
    }
    setTimeout(() => {
      z_(), (kn.userData.rotate = !0);
    }, L_);
  }
}
function z_() {
  ...
  (s.style.position = "fixed"),
    ...
    (s.style.left = "50%"),
    (s.style.transform = "translate(-50%, -50%)"),
    (s.style.color = "#FF1493"),
    (s.style.fontSize = "36px"),
    (s.style.fontFamily = "Arial, sans-serif"),
    (s.style.textAlign = "center"),
    (s.style.zIndex = "999"),
    (s.innerHTML = "Happy Birthday!<br>Bangaarammmmmm!!!!!"),
    (s.style.textShadow = "2px 2px 4px rgba(0,0,0,0.3)"),
    (s.style.opacity = "0"),
...
function k_() {
  (pt = document.createElement("div")),
    ...
    (pt.style.padding = "20px"),
    (pt.style.border = "2px solid black"),
    (pt.style.borderRadius = "10px"),
    (pt.style.display = "none"),
    (pt.style.zIndex = "999"),
    (pt.style.maxWidth = "400px"),
    (pt.style.textAlign = "center"),
    (pt.style.boxShadow = "0 4px 8px rgba(0,0,0,0.3)");
  const s = document.createElement("p");
  (s.textContent =
    "Wow you gave me a new life! Are you the one who loves noodles, biryani and chocolate cake? My creator told me that he loves you so much and that you will save me one day. Thank you so much for giving me a new life. He also left a message for you. Don't forget to close the video after you watched it fully."),
    (s.style.marginBottom = "15px");
  const e = document.createElement("a");
  (e.href = "#"),
    (e.textContent = "Click here to view the message"),
    (e.style.color = "#007bff"),
    (e.style.textDecoration = "underline"),
    (e.onclick = () => {
      (Rl.style.display = "block"), (pt.style.display = "none");
      const t = document.getElementById("youtubePlayer");
      return (
        t &&
          t.contentWindow &&
...
function V_() {
  const s = new fs(10, 10),
    e = new Tn({ visible: !1, side: Qt }),
    t = new Et(s, e);
  (t.position.y = -2), (t.name = "invisibleFloor"), mt.add(t);
}
function Pl(s, e) {
  if (!et || !et.userData || !Ut) return;
  const t = document.getElementById("titleMessage");
  t &&
    ...
    (wi.x = (s / window.innerWidth) * 2 - 1),
    (wi.y = -(e / window.innerHeight) * 2 + 1),
    ir.setFromCamera(wi, Hn),
    ir.intersectObject(Ut).length > 0 &&
      (console.log("Flower hitbox clicked"), (et.userData.shouldMove = !0));
}
function Ll(s, e) {
  if (!et || !et.userData || !et.userData.shouldMove || !Ut) return;
  (wi.x = (s / window.innerWidth) * 2 - 1),
    (wi.y = -(e / window.innerHeight) * 2 + 1),
    ir.setFromCamera(wi, Hn);
  const t = mt.getObjectByName("invisibleFloor");
  if (t) {
    const n = ir.intersectObject(t);
    if (n.length > 0) {
      const i = n[0].point.y;
      (et.position.y = i), (Ut.position.y = i);
    }
  }
}
function Il() {
  !et ||
    !et.userData ||
    !et.userData.shouldMove ||
    ((et.userData.shouldMove = !1),
    console.log("Interaction ended, checking for collision..."),
    Y_());
}
function G_(s) {
  Pl(s.clientX, s.clientY);
}
function W_(s) {
  Ll(s.clientX, s.clientY);
}
function zc() {
  Il();
}
function X_(s) {
  s.preventDefault();
  const e = s.touches[0];
  Pl(e.clientX, e.clientY);
}
function q_(s) {
  s.preventDefault();
  const e = s.touches[0];
  Ll(e.clientX, e.clientY);
}
function Hc() {
  Il();
}
function Y_() {
  if (!et || !Ct || !Ut) return;
  const s = new Kt().setFromObject(Ut),
    e = new Kt().setFromObject(Ct);
  if (s.intersectsBox(e)) {
    console.log("Collision Detected! The flower has been placed in the pot.");
    const t = Ct.position.y + 0.25;
    (et.position.x = Ct.position.x),
      (et.position.z = Ct.position.z),
      (et.position.y = t + 0.5),
      Ut.position.copy(et.position),
      (pt.style.display = "block"),
      (et.userData.shouldMove = !1),
      mt.remove(Ut),
      (Ut = null);
  } else console.log("No collision. The flower was not placed in the pot.");
}
function Dl() {
